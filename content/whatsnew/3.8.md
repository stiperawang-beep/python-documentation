...
[`len()`](../library/functions.md#len) twice:
...
[Argument Clinic](https://devguide.python.org/development-tools/clinic/) tool.
...
the built-in [`divmod()`](../library/functions.md#divmod) function does not accept keyword arguments:
...
name is not helpful.  For example, the builtin [`len()`](../library/functions.md#len) function has
...
breaking client code.  For example, in the [`statistics`](../library/statistics.md#module-statistics) module, the
...
is an excerpt from code in the [`collections`](../library/collections.md#module-collections) module:
...
The new [`PYTHONPYCACHEPREFIX`](../using/cmdline.md#envvar-PYTHONPYCACHEPREFIX) setting (also available as
[`-X`](../using/cmdline.md#cmdoption-X) `pycache_prefix`) configures the implicit bytecode
cache to use a separate parallel filesystem tree, rather than
the default `__pycache__` subdirectories within each source
directory.

The location of the cache is reported in [`sys.pycache_prefix`](../library/sys.md#sys.pycache_prefix)
([`None`](../library/constants.md#None) indicates the default location in `__pycache__`
subdirectories).
...
The ABI of Python [debug builds](../using/configure.md#debug-build)  is now compatible with
...
which adds the [`sys.getobjects()`](../library/sys.md#sys.getobjects) function and the [`PYTHONDUMPREFS`](../using/cmdline.md#envvar-PYTHONDUMPREFS)
environment variable, can be set using the new [`./configure
--with-trace-refs`](../using/configure.md#cmdoption-with-trace-refs) build option.
...
<a id="bpo-36817-whatsnew"></a>

### f-strings support `=` for self-documenting expressions and debugging

Added an `=` specifier to [f-string](../glossary.md#term-f-string)s. An f-string such as
...
The usual [f-string format specifiers](../reference/lexical_analysis.md#f-strings) allow more
...
* [`PyConfig`](../c-api/init_config.md#c.PyConfig)
* [`PyPreConfig`](../c-api/init_config.md#c.PyPreConfig)
* [`PyStatus`](../c-api/init_config.md#c.PyStatus)
* [`PyWideStringList`](../c-api/init_config.md#c.PyWideStringList)

New functions:

* [`PyConfig_Clear()`](../c-api/init_config.md#c.PyConfig_Clear)
* [`PyConfig_InitIsolatedConfig()`](../c-api/init_config.md#c.PyConfig_InitIsolatedConfig)
* [`PyConfig_InitPythonConfig()`](../c-api/init_config.md#c.PyConfig_InitPythonConfig)
* [`PyConfig_Read()`](../c-api/init_config.md#c.PyConfig_Read)
* [`PyConfig_SetArgv()`](../c-api/init_config.md#c.PyConfig_SetArgv)
* [`PyConfig_SetBytesArgv()`](../c-api/init_config.md#c.PyConfig_SetBytesArgv)
* [`PyConfig_SetBytesString()`](../c-api/init_config.md#c.PyConfig_SetBytesString)
* [`PyConfig_SetString()`](../c-api/init_config.md#c.PyConfig_SetString)
* [`PyPreConfig_InitIsolatedConfig()`](../c-api/init_config.md#c.PyPreConfig_InitIsolatedConfig)
* [`PyPreConfig_InitPythonConfig()`](../c-api/init_config.md#c.PyPreConfig_InitPythonConfig)
* [`PyStatus_Error()`](../c-api/init_config.md#c.PyStatus_Error)
* [`PyStatus_Exception()`](../c-api/init_config.md#c.PyStatus_Exception)
* [`PyStatus_Exit()`](../c-api/init_config.md#c.PyStatus_Exit)
* [`PyStatus_IsError()`](../c-api/init_config.md#c.PyStatus_IsError)
* [`PyStatus_IsExit()`](../c-api/init_config.md#c.PyStatus_IsExit)
* [`PyStatus_NoMemory()`](../c-api/init_config.md#c.PyStatus_NoMemory)
* [`PyStatus_Ok()`](../c-api/init_config.md#c.PyStatus_Ok)
* [`PyWideStringList_Append()`](../c-api/init_config.md#c.PyWideStringList_Append)
* [`PyWideStringList_Insert()`](../c-api/init_config.md#c.PyWideStringList_Insert)
* [`Py_BytesMain()`](../c-api/interp-lifecycle.md#c.Py_BytesMain)
* [`Py_ExitStatusException()`](../c-api/init_config.md#c.Py_ExitStatusException)
* [`Py_InitializeFromConfig()`](../c-api/interp-lifecycle.md#c.Py_InitializeFromConfig)
* [`Py_PreInitialize()`](../c-api/init_config.md#c.Py_PreInitialize)
* [`Py_PreInitializeFromArgs()`](../c-api/init_config.md#c.Py_PreInitializeFromArgs)
* [`Py_PreInitializeFromBytesArgs()`](../c-api/init_config.md#c.Py_PreInitializeFromBytesArgs)
* [`Py_RunMain()`](../c-api/interp-lifecycle.md#c.Py_RunMain)

This PEP also adds `_PyRuntimeState.preconfig` ([`PyPreConfig`](../c-api/init_config.md#c.PyPreConfig) type)
and `PyInterpreterState.config` ([`PyConfig`](../c-api/init_config.md#c.PyConfig) type) fields to these
...
See [Python Initialization Configuration](../c-api/init_config.md#init-config) for the
documentation.
...
[The Vectorcall Protocol](../c-api/call.md#vectorcall) is added to the Python/C API.
It is meant to formalize existing optimizations which were already done
for various classes.
Any [static type](../c-api/typeobj.md#static-types) implementing a callable can use this
protocol.
...
When [`pickle`](../library/pickle.md#module-pickle) is used to transfer large data between Python processes
...
The [`pickle`](../library/pickle.md#module-pickle) protocol 5 introduces support for out-of-band buffers
...
* A [`continue`](../reference/simple_stmts.md#continue) statement was illegal in the [`finally`](../reference/compound_stmts.md#finally) clause
  due to a problem with the implementation.  In Python 3.8 this restriction
  was lifted.
  (Contributed by Serhiy Storchaka in [bpo-32489](https://bugs.python.org/issue?@action=redirect&bpo=32489).)
* The [`bool`](../library/functions.md#bool), [`int`](../library/functions.md#int), and [`fractions.Fraction`](../library/fractions.md#fractions.Fraction) types
  now have an [`as_integer_ratio()`](../library/stdtypes.md#int.as_integer_ratio) method like that found in
  [`float`](../library/functions.md#float) and [`decimal.Decimal`](../library/decimal.md#decimal.Decimal).  This minor API extension
...
* Constructors of [`int`](../library/functions.md#int), [`float`](../library/functions.md#float) and [`complex`](../library/functions.md#complex) will now
  use the [`__index__()`](../reference/datamodel.md#object.__index__) special method, if available and the
  corresponding method [`__int__()`](../reference/datamodel.md#object.__int__), [`__float__()`](../reference/datamodel.md#object.__float__)
  or [`__complex__()`](../reference/datamodel.md#object.__complex__) is not available.
  (Contributed by Serhiy Storchaka in [bpo-20092](https://bugs.python.org/issue?@action=redirect&bpo=20092).)
* Added support of `\N{*name*}` escapes in [`regular expressions`](../library/re.md#module-re):
  ```python3
...
* Dict and dictviews are now iterable in reversed insertion order using
  [`reversed()`](../library/functions.md#reversed). (Contributed by Rémi Lapeyre in [bpo-33462](https://bugs.python.org/issue?@action=redirect&bpo=33462).)
...
* Generalized iterable unpacking in [`yield`](../reference/simple_stmts.md#yield) and
  [`return`](../reference/simple_stmts.md#return) statements no longer requires enclosing parentheses.
...
* When a comma is missed in code such as `[(10, 20) (30, 40)]`, the
  compiler displays a [`SyntaxWarning`](../library/exceptions.md#SyntaxWarning) with a helpful suggestion.
  This improves on just having a [`TypeError`](../library/exceptions.md#TypeError) indicating that the
...
* Arithmetic operations between subclasses of [`datetime.date`](../library/datetime.md#datetime.date) or
  [`datetime.datetime`](../library/datetime.md#datetime.datetime) and [`datetime.timedelta`](../library/datetime.md#datetime.timedelta) objects now return
  ...
  uses [`datetime.timedelta`](../library/datetime.md#datetime.timedelta) arithmetic, such as
  [`astimezone()`](../library/datetime.md#datetime.datetime.astimezone).
...
* When the Python interpreter is interrupted by Ctrl-C (SIGINT) and the
  resulting [`KeyboardInterrupt`](../library/exceptions.md#KeyboardInterrupt) exception is not caught, the Python process
...
* Some advanced styles of programming require updating the
  [`types.CodeType`](../library/types.md#types.CodeType) object for an existing function.  Since code
  ...
  Here’s an example that alters the [`statistics.mean()`](../library/statistics.md#statistics.mean) function to
...
* For integers, the three-argument form of the [`pow()`](../library/functions.md#pow) function now
...
* The [`object.__reduce__()`](../library/pickle.md#object.__reduce__) method can now return a tuple from two to
  ...
  [`__setstate__()`](../library/pickle.md#object.__setstate__) method.
  (Contributed by Pierre Glaser and Olivier Grisel in [bpo-35900](https://bugs.python.org/issue?@action=redirect&bpo=35900).)

## New Modules

* The new [`importlib.metadata`](../library/importlib.metadata.md#module-importlib.metadata) module provides (provisional) support for
...
New function [`ast.get_source_segment()`](../library/ast.md#ast.get_source_segment) returns the source code
for a specific AST node.

(Contributed by Ivan Levkivskyi in [bpo-33416](https://bugs.python.org/issue?@action=redirect&bpo=33416).)

The [`ast.parse()`](../library/ast.md#ast.parse) function has some new flags:
...
* `feature_version=(3, N)` allows specifying an earlier Python 3
  ...
  [`async`](../reference/compound_stmts.md#async) and [`await`](../reference/expressions.md#await) as non-reserved words.

(Contributed by Guido van Rossum in [bpo-35766](https://bugs.python.org/issue?@action=redirect&bpo=35766).)

### asyncio

[`asyncio.run()`](../library/asyncio-runner.md#asyncio.run) has graduated from the provisional to stable API. This
function can be used to execute a [coroutine](../glossary.md#term-coroutine) and return the result while
...
[`asyncio.run()`](../library/asyncio-runner.md#asyncio.run) should be the preferred way of running asyncio programs.
...
experimentation with code that has a top-level [`await`](../reference/expressions.md#await).  There is no
...
The exception [`asyncio.CancelledError`](../library/asyncio-exceptions.md#asyncio.CancelledError) now inherits from
[`BaseException`](../library/exceptions.md#BaseException) rather than [`Exception`](../library/exceptions.md#Exception) and no longer inherits
from [`concurrent.futures.CancelledError`](../library/concurrent.futures.md#concurrent.futures.CancelledError).
(Contributed by Yury Selivanov in [bpo-32528](https://bugs.python.org/issue?@action=redirect&bpo=32528).)

On Windows, the default event loop is now [`ProactorEventLoop`](../library/asyncio-eventloop.md#asyncio.ProactorEventLoop).
(Contributed by Victor Stinner in [bpo-34687](https://bugs.python.org/issue?@action=redirect&bpo=34687).)

[`ProactorEventLoop`](../library/asyncio-eventloop.md#asyncio.ProactorEventLoop) now also supports UDP.
(Contributed by Adam Meily and Andrew Svetlov in [bpo-29883](https://bugs.python.org/issue?@action=redirect&bpo=29883).)

[`ProactorEventLoop`](../library/asyncio-eventloop.md#asyncio.ProactorEventLoop) can now be interrupted by
[`KeyboardInterrupt`](../library/exceptions.md#KeyboardInterrupt) (“CTRL+C”).
(Contributed by Vladimir Matveev in [bpo-23057](https://bugs.python.org/issue?@action=redirect&bpo=23057).)

Added [`asyncio.Task.get_coro()`](../library/asyncio-task.md#asyncio.Task.get_coro) for getting the wrapped coroutine
within an [`asyncio.Task`](../library/asyncio-task.md#asyncio.Task).
(Contributed by Alex Grönholm in [bpo-36999](https://bugs.python.org/issue?@action=redirect&bpo=36999).)

Asyncio tasks can now be named, either by passing the `name` keyword
argument to [`asyncio.create_task()`](../library/asyncio-task.md#asyncio.create_task) or
the [`create_task()`](../library/asyncio-eventloop.md#asyncio.loop.create_task) event loop method, or by
calling the [`set_name()`](../library/asyncio-task.md#asyncio.Task.set_name) method on the task object. The
task name is visible in the `repr()` output of [`asyncio.Task`](../library/asyncio-task.md#asyncio.Task) and
can also be retrieved using the [`get_name()`](../library/asyncio-task.md#asyncio.Task.get_name) method.
...
[`asyncio.loop.create_connection()`](../library/asyncio-eventloop.md#asyncio.loop.create_connection). To specify the behavior, two new
...
The [`compile()`](../library/functions.md#compile) built-in has been improved to accept the
`ast.PyCF_ALLOW_TOP_LEVEL_AWAIT` flag. With this new flag passed,
[`compile()`](../library/functions.md#compile) will allow top-level `await`, `async for` and `async with`
...
[`collections.namedtuple()`](../library/collections.md#collections.namedtuple) now returns a [`dict`](../library/stdtypes.md#dict) instead of a
[`collections.OrderedDict`](../library/collections.md#collections.OrderedDict). This works because regular dicts have
...
The [`cProfile.Profile`](../library/profile.md#profile.Profile) class can now be used as a context manager.
...
The [`csv.DictReader`](../library/csv.md#csv.DictReader) now returns instances of [`dict`](../library/stdtypes.md#dict) instead of
a [`collections.OrderedDict`](../library/collections.md#collections.OrderedDict).  The tool is now faster and uses less
...
underlying ncurses library: [`ncurses_version`](../library/curses.md#curses.ncurses_version).
(Contributed by Serhiy Storchaka in [bpo-31680](https://bugs.python.org/issue?@action=redirect&bpo=31680).)

### ctypes

On Windows, [`CDLL`](../library/ctypes.md#ctypes.CDLL) and subclasses now accept a *winmode* parameter
...
DLL) and paths added by [`add_dll_directory()`](../library/os.md#os.add_dll_directory).
(Contributed by Steve Dower in [bpo-36085](https://bugs.python.org/issue?@action=redirect&bpo=36085).)

### datetime

Added new alternate constructors [`datetime.date.fromisocalendar()`](../library/datetime.md#datetime.date.fromisocalendar) and
[`datetime.datetime.fromisocalendar()`](../library/datetime.md#datetime.datetime.fromisocalendar), which construct [`date`](../library/datetime.md#datetime.date) and
[`datetime`](../library/datetime.md#datetime.datetime) objects respectively from ISO year, week number, and weekday;
...
[`functools.lru_cache()`](../library/functools.md#functools.lru_cache) can now be used as a straight decorator rather
...
Added a new [`functools.cached_property()`](../library/functools.md#functools.cached_property) decorator, for computed properties
...
Added a new [`functools.singledispatchmethod()`](../library/functools.md#functools.singledispatchmethod) decorator that converts
methods into [generic functions](../glossary.md#term-generic-function) using
[single dispatch](../glossary.md#term-single-dispatch):
...
[`get_objects()`](../library/gc.md#gc.get_objects) can now receive an optional *generation* parameter
...
Added [`pgettext()`](../library/gettext.md#gettext.pgettext) and its variants.
...
Added the *mtime* parameter to [`gzip.compress()`](../library/gzip.md#gzip.compress) for reproducible output.
(Contributed by Guo Ci Teo in [bpo-34898](https://bugs.python.org/issue?@action=redirect&bpo=34898).)

A [`BadGzipFile`](../library/gzip.md#gzip.BadGzipFile) exception is now raised instead of [`OSError`](../library/exceptions.md#OSError)
...
The [`inspect.getdoc()`](../library/inspect.md#inspect.getdoc) function can now find docstrings for `__slots__`
if that attribute is a [`dict`](../library/stdtypes.md#dict) where the values are docstrings.
This provides documentation options similar to what we already have
for [`property()`](../library/functions.md#property), [`classmethod()`](../library/functions.md#classmethod), and [`staticmethod()`](../library/functions.md#staticmethod):
...
In development mode ([`-X`](../using/cmdline.md#cmdoption-X) `env`) and in [debug build](../using/configure.md#debug-build), the
[`io.IOBase`](../library/io.md#io.IOBase) finalizer now logs the exception if the `close()` method
fails. The exception is ignored silently by default in release build.
(Contributed by Victor Stinner in [bpo-18748](https://bugs.python.org/issue?@action=redirect&bpo=18748).)

### itertools

The [`itertools.accumulate()`](../library/itertools.md#itertools.accumulate) function added an option *initial* keyword
...
Added a *force* keyword argument to [`logging.basicConfig()`](../library/logging.md#logging.basicConfig).
...
Added new function [`math.dist()`](../library/math.md#math.dist) for computing Euclidean distance
between two points.  (Contributed by Raymond Hettinger in [bpo-33089](https://bugs.python.org/issue?@action=redirect&bpo=33089).)

Expanded the [`math.hypot()`](../library/math.md#math.hypot) function to handle multiple dimensions.
...
Added new function, [`math.prod()`](../library/math.md#math.prod), as analogous function to [`sum()`](../library/functions.md#sum)
...
Added two new combinatoric functions [`math.perm()`](../library/math.md#math.perm) and [`math.comb()`](../library/math.md#math.comb):
...
Added a new function [`math.isqrt()`](../library/math.md#math.isqrt) for computing accurate integer square
...
than [`math.sqrt()`](../library/math.md#math.sqrt):
...
The function [`math.factorial()`](../library/math.md#math.factorial) no longer accepts arguments that are not
int-like. (Contributed by Pablo Galindo in [bpo-33083](https://bugs.python.org/issue?@action=redirect&bpo=33083).)

### mmap

The [`mmap.mmap`](../library/mmap.md#mmap.mmap) class now has an [`madvise()`](../library/mmap.md#mmap.mmap.madvise) method to
...
Added new [`multiprocessing.shared_memory`](../library/multiprocessing.shared_memory.md#module-multiprocessing.shared_memory) module.
...
Added new function [`add_dll_directory()`](../library/os.md#os.add_dll_directory) on Windows for providing
additional search paths for native dependencies when importing extension
modules or loading DLLs using [`ctypes`](../library/ctypes.md#module-ctypes).
(Contributed by Steve Dower in [bpo-36085](https://bugs.python.org/issue?@action=redirect&bpo=36085).)

A new [`os.memfd_create()`](../library/os.md#os.memfd_create) function was added to wrap the
...
Specifically, [`os.stat()`](../library/os.md#os.stat) will now traverse anything supported by the
operating system, while [`os.lstat()`](../library/os.md#os.lstat) will only open reparse points that
identify as “name surrogates” while others are opened as for [`os.stat()`](../library/os.md#os.stat).
In all cases, [`os.stat_result.st_mode`](../library/os.md#os.stat_result.st_mode) will only have `S_IFLNK` set for
symbolic links and not other kinds of reparse points. To identify other kinds
of reparse point, check the new [`os.stat_result.st_reparse_tag`](../library/os.md#os.stat_result.st_reparse_tag) attribute.

On Windows, [`os.readlink()`](../library/os.md#os.readlink) is now able to read directory junctions. Note
that [`islink()`](../library/os.path.md#os.path.islink) will return `False` for directory junctions,
and so code that checks `islink` first will continue to treat junctions as
directories, while code that handles errors from [`os.readlink()`](../library/os.md#os.readlink) may now
...
[`os.path`](../library/os.path.md#module-os.path) functions that return a boolean result like
[`exists()`](../library/os.path.md#os.path.exists), [`lexists()`](../library/os.path.md#os.path.lexists), [`isdir()`](../library/os.path.md#os.path.isdir),
[`isfile()`](../library/os.path.md#os.path.isfile), [`islink()`](../library/os.path.md#os.path.islink), and [`ismount()`](../library/os.path.md#os.path.ismount)
now return `False` instead of raising [`ValueError`](../library/exceptions.md#ValueError) or its subclasses
[`UnicodeEncodeError`](../library/exceptions.md#UnicodeEncodeError) and [`UnicodeDecodeError`](../library/exceptions.md#UnicodeDecodeError) for paths that contain
...
[`expanduser()`](../library/os.path.md#os.path.expanduser) on Windows now prefers the `USERPROFILE`
...
[`isdir()`](../library/os.path.md#os.path.isdir) on Windows no longer returns `True` for a link to a
non-existent directory.

[`realpath()`](../library/os.path.md#os.path.realpath) on Windows now resolves reparse points, including
...
[`pathlib.Path`](../library/pathlib.md#pathlib.Path) methods that return a boolean result like
[`exists()`](../library/pathlib.md#pathlib.Path.exists), [`is_dir()`](../library/pathlib.md#pathlib.Path.is_dir),
[`is_file()`](../library/pathlib.md#pathlib.Path.is_file), [`is_mount()`](../library/pathlib.md#pathlib.Path.is_mount),
[`is_symlink()`](../library/pathlib.md#pathlib.Path.is_symlink), [`is_block_device()`](../library/pathlib.md#pathlib.Path.is_block_device),
[`is_char_device()`](../library/pathlib.md#pathlib.Path.is_char_device), [`is_fifo()`](../library/pathlib.md#pathlib.Path.is_fifo),
[`is_socket()`](../library/pathlib.md#pathlib.Path.is_socket) now return `False` instead of raising
[`ValueError`](../library/exceptions.md#ValueError) or its subclass [`UnicodeEncodeError`](../library/exceptions.md#UnicodeEncodeError) for paths that
...
[`pickle`](../library/pickle.md#module-pickle) extensions subclassing the C-optimized [`Pickler`](../library/pickle.md#pickle.Pickler)
can now override the pickling logic of functions and classes by defining the
special [`reducer_override()`](../library/pickle.md#pickle.Pickler.reducer_override) method.
(Contributed by Pierre Glaser and Olivier Grisel in [bpo-35900](https://bugs.python.org/issue?@action=redirect&bpo=35900).)

### plistlib

Added new [`plistlib.UID`](../library/plistlib.md#plistlib.UID) and enabled support for reading and writing
...
The [`pprint`](../library/pprint.md#module-pprint) module added a *sort_dicts* parameter to several functions.
...
In addition, there is a convenience new function, [`pprint.pp()`](../library/pprint.md#pprint.pp) that is
like [`pprint.pprint()`](../library/pprint.md#pprint.pprint) but with *sort_dicts* defaulting to `False`:
...
[`py_compile.compile()`](../library/py_compile.md#py_compile.compile) now supports silent mode.
(Contributed by Joannah Nanjekye in [bpo-22640](https://bugs.python.org/issue?@action=redirect&bpo=22640).)

### shlex

The new [`shlex.join()`](../library/shlex.md#shlex.join) function acts as the inverse of [`shlex.split()`](../library/shlex.md#shlex.split).
(Contributed by Bo Bayles in [bpo-32102](https://bugs.python.org/issue?@action=redirect&bpo=32102).)

### shutil

[`shutil.copytree()`](../library/shutil.md#shutil.copytree) now accepts a new `dirs_exist_ok` keyword argument.
(Contributed by Josh Bronson in [bpo-20849](https://bugs.python.org/issue?@action=redirect&bpo=20849).)

[`shutil.make_archive()`](../library/shutil.md#shutil.make_archive) now defaults to the modern pax (POSIX.1-2001)
format for new archives to improve portability and standards conformance,
inherited from the corresponding change to the [`tarfile`](../library/tarfile.md#module-tarfile) module.
(Contributed by C.A.M. Gerlach in [bpo-30661](https://bugs.python.org/issue?@action=redirect&bpo=30661).)

[`shutil.rmtree()`](../library/shutil.md#shutil.rmtree) on Windows now removes directory junctions without
recursively removing their contents first.
(Contributed by Steve Dower in [bpo-37834](https://bugs.python.org/issue?@action=redirect&bpo=37834).)

### socket

Added [`create_server()`](../library/socket.md#socket.create_server) and [`has_dualstack_ipv6()`](../library/socket.md#socket.has_dualstack_ipv6)
...
The [`socket.if_nameindex()`](../library/socket.md#socket.if_nameindex), [`socket.if_nametoindex()`](../library/socket.md#socket.if_nametoindex), and
[`socket.if_indextoname()`](../library/socket.md#socket.if_indextoname) functions have been implemented on Windows.
(Contributed by Zackery Spytz in [bpo-37007](https://bugs.python.org/issue?@action=redirect&bpo=37007).)

### ssl

Added [`post_handshake_auth`](../library/ssl.md#ssl.SSLContext.post_handshake_auth) to enable and
[`verify_client_post_handshake()`](../library/ssl.md#ssl.SSLSocket.verify_client_post_handshake) to initiate TLS 1.3
post-handshake authentication.
(Contributed by Christian Heimes in [bpo-34670](https://bugs.python.org/issue?@action=redirect&bpo=34670).)

### statistics

Added [`statistics.fmean()`](../library/statistics.md#statistics.fmean) as a faster, floating-point variant of
[`statistics.mean()`](../library/statistics.md#statistics.mean).  (Contributed by Raymond Hettinger and
Steven D’Aprano in [bpo-35904](https://bugs.python.org/issue?@action=redirect&bpo=35904).)

Added [`statistics.geometric_mean()`](../library/statistics.md#statistics.geometric_mean)
(Contributed by Raymond Hettinger in [bpo-27181](https://bugs.python.org/issue?@action=redirect&bpo=27181).)

Added [`statistics.multimode()`](../library/statistics.md#statistics.multimode) that returns a list of the most
common values. (Contributed by Raymond Hettinger in [bpo-35892](https://bugs.python.org/issue?@action=redirect&bpo=35892).)

Added [`statistics.quantiles()`](../library/statistics.md#statistics.quantiles) that divides data or a distribution
...
Added [`statistics.NormalDist`](../library/statistics.md#statistics.NormalDist), a tool for creating
...
Add new [`sys.unraisablehook()`](../library/sys.md#sys.unraisablehook) function which can be overridden to control
...
([`gc.collect()`](../library/gc.md#gc.collect)).
(Contributed by Victor Stinner in [bpo-36829](https://bugs.python.org/issue?@action=redirect&bpo=36829).)

### tarfile

The [`tarfile`](../library/tarfile.md#module-tarfile) module now defaults to the modern pax (POSIX.1-2001)
...
Add a new [`threading.excepthook()`](../library/threading.md#threading.excepthook) function which handles uncaught
[`threading.Thread.run()`](../library/threading.md#threading.Thread.run) exception. It can be overridden to control how
uncaught [`threading.Thread.run()`](../library/threading.md#threading.Thread.run) exceptions are handled.
(Contributed by Victor Stinner in [bpo-1230540](https://bugs.python.org/issue?@action=redirect&bpo=1230540).)

Add a new [`threading.get_native_id()`](../library/threading.md#threading.get_native_id) function and
a [`native_id`](../library/threading.md#threading.Thread.native_id)
attribute to the [`threading.Thread`](../library/threading.md#threading.Thread) class. These return the native
integral Thread ID of the current thread assigned by the kernel.
This feature is only available on certain platforms, see
[`get_native_id`](../library/threading.md#threading.get_native_id) for more information.
(Contributed by Jake Tesler in [bpo-36084](https://bugs.python.org/issue?@action=redirect&bpo=36084).)

### tokenize

The [`tokenize`](../library/tokenize.md#module-tokenize) module now implicitly emits a `NEWLINE` token when
...
Added new clock [`CLOCK_UPTIME_RAW`](../library/time.md#time.CLOCK_UPTIME_RAW) for macOS 10.12.
(Contributed by Joannah Nanjekye in [bpo-35702](https://bugs.python.org/issue?@action=redirect&bpo=35702).)

### typing

The [`typing`](../library/typing.md#module-typing) module incorporates several new features:

* A dictionary type with per-key types.  See [**PEP 589**](https://peps.python.org/pep-0589/) and
  [`typing.TypedDict`](../library/typing.md#typing.TypedDict).
  ...
  class Location(TypedDict, total=False):
      ...
      xy_coordinate: tuple
  ```
* Literal types.  See [**PEP 586**](https://peps.python.org/pep-0586/) and [`typing.Literal`](../library/typing.md#typing.Literal).
...
* “Final” variables, functions, methods and classes.  See [**PEP 591**](https://peps.python.org/pep-0591/),
  [`typing.Final`](../library/typing.md#typing.Final) and [`typing.final()`](../library/typing.md#typing.final).
  The final qualifier instructs a static type checker to restrict
  subclassing, overriding, or reassignment:
  ```python3
  pi: Final[float] = 3.1415926536
  ```
* Protocol definitions.  See [**PEP 544**](https://peps.python.org/pep-0544/), [`typing.Protocol`](../library/typing.md#typing.Protocol) and
  [`typing.runtime_checkable()`](../library/typing.md#typing.runtime_checkable).  Simple ABCs like
  [`typing.SupportsInt`](../library/typing.md#typing.SupportsInt) are now `Protocol` subclasses.
* New protocol class [`typing.SupportsIndex`](../library/typing.md#typing.SupportsIndex).
* New functions [`typing.get_origin()`](../library/typing.md#typing.get_origin) and [`typing.get_args()`](../library/typing.md#typing.get_args).

### unicodedata

The [`unicodedata`](../library/unicodedata.md#module-unicodedata) module has been upgraded to use the [Unicode 12.1.0](https://blog.unicode.org/2019/05/unicode-12-1-en.html) release.

New function [`is_normalized()`](../library/unicodedata.md#unicodedata.is_normalized) can be used to verify a string
...
Added [`AsyncMock`](../library/unittest.mock.md#unittest.mock.AsyncMock) to support an asynchronous version of
[`Mock`](../library/unittest.mock.md#unittest.mock.Mock).  Appropriate new assert functions for testing
have been added as well.
(Contributed by Lisa Roach in [bpo-26467](https://bugs.python.org/issue?@action=redirect&bpo=26467)).

Added [`addModuleCleanup()`](../library/unittest.md#unittest.addModuleCleanup) and
[`addClassCleanup()`](../library/unittest.md#unittest.TestCase.addClassCleanup) to unittest to support
cleanups for [`setUpModule()`](../library/unittest.md#unittest.setUpModule) and
[`setUpClass()`](../library/unittest.md#unittest.TestCase.setUpClass).
...
[`unittest`](../library/unittest.md#module-unittest) module gained support for coroutines to be used as test cases
with [`unittest.IsolatedAsyncioTestCase`](../library/unittest.md#unittest.IsolatedAsyncioTestCase).
...
[`venv`](../library/venv.md#module-venv) now includes an `Activate.ps1` script on all platforms for
activating virtual environments under PowerShell Core 6.1.
(Contributed by Brett Cannon in [bpo-32718](https://bugs.python.org/issue?@action=redirect&bpo=32718).)

### weakref

The proxy objects returned by [`weakref.proxy()`](../library/weakref.md#weakref.proxy) now support the matrix
...
The `.find*()` methods in the [`xml.etree.ElementTree`](../library/xml.etree.elementtree.md#module-xml.etree.ElementTree) module
...
The [`xml.etree.ElementTree`](../library/xml.etree.elementtree.md#module-xml.etree.ElementTree) module provides a new function
[`canonicalize()`](../library/xml.etree.elementtree.md#xml.etree.ElementTree.canonicalize) that implements C14N 2.0.
(Contributed by Stefan Behnel in [bpo-13611](https://bugs.python.org/issue?@action=redirect&bpo=13611).)

The target object of [`xml.etree.ElementTree.XMLParser`](../library/xml.etree.elementtree.md#xml.etree.ElementTree.XMLParser) can
receive namespace declaration events through the new callback methods
`start_ns()` and `end_ns()`.  Additionally, the
[`xml.etree.ElementTree.TreeBuilder`](../library/xml.etree.elementtree.md#xml.etree.ElementTree.TreeBuilder) target can be configured
...
[`xmlrpc.client.ServerProxy`](../library/xmlrpc.client.md#xmlrpc.client.ServerProxy) now supports an optional *headers* keyword
...
* The [`subprocess`](../library/subprocess.md#module-subprocess) module can now use the [`os.posix_spawn()`](../library/os.md#os.posix_spawn) function
...
* [`shutil.copyfile()`](../library/shutil.md#shutil.copyfile), [`shutil.copy()`](../library/shutil.md#shutil.copy), [`shutil.copy2()`](../library/shutil.md#shutil.copy2),
  [`shutil.copytree()`](../library/shutil.md#shutil.copytree) and [`shutil.move()`](../library/shutil.md#shutil.move) use platform-specific
  ...
  On Windows [`shutil.copyfile()`](../library/shutil.md#shutil.copyfile) uses a bigger default buffer size (1 MiB
  instead of 16 KiB) and a [`memoryview()`](../library/stdtypes.md#memoryview)-based variant of
  [`shutil.copyfileobj()`](../library/shutil.md#shutil.copyfileobj) is used.
  ...
  are consumed.
  See [Platform-dependent efficient copy operations](../library/shutil.md#shutil-platform-dependent-efficient-copy-operations) section.
  (Contributed by Giampaolo Rodolà in [bpo-33671](https://bugs.python.org/issue?@action=redirect&bpo=33671).)
* [`shutil.copytree()`](../library/shutil.md#shutil.copytree) uses [`os.scandir()`](../library/os.md#os.scandir) function and all copy
  functions depending from it use cached [`os.stat()`](../library/os.md#os.stat) values. The speedup
  for copying a directory with 8000 files is around +9% on Linux, +20% on
  Windows and +30% on a Windows SMB share. Also the number of [`os.stat()`](../library/os.md#os.stat)
  syscalls is reduced by 38% making [`shutil.copytree()`](../library/shutil.md#shutil.copytree) especially faster
...
* The default protocol in the [`pickle`](../library/pickle.md#module-pickle) module is now Protocol 4,
  first introduced in Python 3.4.  It offers better performance and smaller
  size compared to Protocol 3 available since Python 3.0.
* Removed one [`Py_ssize_t`](../c-api/intro.md#c.Py_ssize_t) member from `PyGC_Head`.  All GC tracked
  objects (e.g. tuple, list, dict) size is reduced 4 or 8 bytes.
  (Contributed by Inada Naoki in [bpo-33597](https://bugs.python.org/issue?@action=redirect&bpo=33597).)
* [`uuid.UUID`](../library/uuid.md#uuid.UUID) now uses `__slots__` to reduce its memory footprint.
  (Contributed by Wouter Bolsterlee and Tal Einat in [bpo-30977](https://bugs.python.org/issue?@action=redirect&bpo=30977))
* Improved performance of [`operator.itemgetter()`](../library/operator.md#operator.itemgetter) by 33%.  Optimized
...
* Sped-up field lookups in [`collections.namedtuple()`](../library/collections.md#collections.namedtuple).  They are now more
...
* The [`list`](../library/stdtypes.md#list) constructor does not overallocate the internal item buffer
...
* Default [`sys.abiflags`](../library/sys.md#sys.abiflags) became an empty string: the `m` flag for
...
* The header files have been reorganized to better separate the different kinds
  ...
  * `Include/internal/*.h` is the private internal C API very specific to
  ...
  (Contributed by Victor Stinner in [bpo-35134](https://bugs.python.org/issue?@action=redirect&bpo=35134) and [bpo-35081](https://bugs.python.org/issue?@action=redirect&bpo=35081),
...
* Some macros have been converted to static inline functions: parameter types
  ...
  * [`Py_INCREF()`](../c-api/refcounting.md#c.Py_INCREF), [`Py_DECREF()`](../c-api/refcounting.md#c.Py_DECREF)
  * [`Py_XINCREF()`](../c-api/refcounting.md#c.Py_XINCREF), [`Py_XDECREF()`](../c-api/refcounting.md#c.Py_XDECREF)
...
* The result of [`PyExceptionClass_Name()`](../c-api/exceptions.md#c.PyExceptionClass_Name) is now of type
...
* Functions that convert Python number to C integer like
  [`PyLong_AsLong()`](../c-api/long.md#c.PyLong_AsLong) and argument parsing functions like
  [`PyArg_ParseTuple()`](../c-api/arg.md#c.PyArg_ParseTuple) with integer converting format units like `'i'`
  will now use the [`__index__()`](../reference/datamodel.md#object.__index__) special method instead of
  [`__int__()`](../reference/datamodel.md#object.__int__), if available.  The deprecation warning will be
  emitted for objects with the `__int__()` method but without the
  `__index__()` method (like [`Decimal`](../library/decimal.md#decimal.Decimal) and
  [`Fraction`](../library/fractions.md#fractions.Fraction)).  [`PyNumber_Check()`](../c-api/number.md#c.PyNumber_Check) will now return
  `1` for objects implementing `__index__()`.
  [`PyNumber_Long()`](../c-api/number.md#c.PyNumber_Long), [`PyNumber_Float()`](../c-api/number.md#c.PyNumber_Float) and
  [`PyFloat_AsDouble()`](../c-api/float.md#c.PyFloat_AsDouble) also now use the `__index__()` method if
  available.
...
* Heap-allocated type objects will now increase their reference count
  in [`PyObject_Init()`](../c-api/allocation.md#c.PyObject_Init) (and its parallel macro `PyObject_INIT`)
  instead of in [`PyType_GenericAlloc()`](../c-api/type.md#c.PyType_GenericAlloc). Types that modify instance
...
* `Py_SetPath()` now sets [`sys.executable`](../library/sys.md#sys.executable) to the program full
...
* Deprecated methods `getchildren()` and `getiterator()` in
  the [`ElementTree`](../library/xml.etree.elementtree.md#module-xml.etree.ElementTree) module now emit a
  [`DeprecationWarning`](../library/exceptions.md#DeprecationWarning) instead of [`PendingDeprecationWarning`](../library/exceptions.md#PendingDeprecationWarning).
...
* Passing an object that is not an instance of
  [`concurrent.futures.ThreadPoolExecutor`](../library/concurrent.futures.md#concurrent.futures.ThreadPoolExecutor) to
  [`loop.set_default_executor()`](../library/asyncio-eventloop.md#asyncio.loop.set_default_executor) is
  deprecated and will be prohibited in Python 3.9.
  (Contributed by Elvis Pranskevichus in [bpo-34075](https://bugs.python.org/issue?@action=redirect&bpo=34075).)
* The [`__getitem__()`](../reference/datamodel.md#object.__getitem__) methods of [`xml.dom.pulldom.DOMEventStream`](../library/xml.dom.pulldom.md#xml.dom.pulldom.DOMEventStream),
  [`wsgiref.util.FileWrapper`](../library/wsgiref.md#wsgiref.util.FileWrapper) and [`fileinput.FileInput`](../library/fileinput.md#fileinput.FileInput) have been
  deprecated.
...
* The [`typing.NamedTuple`](../library/typing.md#typing.NamedTuple) class has deprecated the `_field_types`
...
* [`ast`](../library/ast.md#module-ast) classes `Num`, `Str`, `Bytes`, `NameConstant` and
  `Ellipsis` are considered deprecated and will be removed in future Python
  versions. [`Constant`](../library/ast.md#ast.Constant) should be used instead.
  (Contributed by Serhiy Storchaka in [bpo-32892](https://bugs.python.org/issue?@action=redirect&bpo=32892).)
* [`ast.NodeVisitor`](../library/ast.md#ast.NodeVisitor) methods `visit_Num()`, `visit_Str()`,
  `visit_Bytes()`, `visit_NameConstant()` and `visit_Ellipsis()` are
  deprecated now and will not be called in future Python versions.
  Add the [`visit_Constant()`](../library/ast.md#ast.NodeVisitor.visit_Constant) method to handle all
  constant nodes.
  (Contributed by Serhiy Storchaka in [bpo-36917](https://bugs.python.org/issue?@action=redirect&bpo=36917).)
* The `asyncio.coroutine` [decorator](../glossary.md#term-decorator) is deprecated and will be
  removed in version 3.10.  Instead of `@asyncio.coroutine`, use
  [`async def`](../reference/compound_stmts.md#async-def) instead.
  (Contributed by Andrew Svetlov in [bpo-36921](https://bugs.python.org/issue?@action=redirect&bpo=36921).)
* In [`asyncio`](../library/asyncio.md#module-asyncio), the explicit passing of a *loop* argument has been
  deprecated and will be removed in version 3.10 for the following:
  [`asyncio.sleep()`](../library/asyncio-task.md#asyncio.sleep), [`asyncio.gather()`](../library/asyncio-task.md#asyncio.gather), [`asyncio.shield()`](../library/asyncio-task.md#asyncio.shield),
  [`asyncio.wait_for()`](../library/asyncio-task.md#asyncio.wait_for), [`asyncio.wait()`](../library/asyncio-task.md#asyncio.wait), [`asyncio.as_completed()`](../library/asyncio-task.md#asyncio.as_completed),
  [`asyncio.Task`](../library/asyncio-task.md#asyncio.Task), [`asyncio.Lock`](../library/asyncio-sync.md#asyncio.Lock), [`asyncio.Event`](../library/asyncio-sync.md#asyncio.Event),
  [`asyncio.Condition`](../library/asyncio-sync.md#asyncio.Condition), [`asyncio.Semaphore`](../library/asyncio-sync.md#asyncio.Semaphore),
  [`asyncio.BoundedSemaphore`](../library/asyncio-sync.md#asyncio.BoundedSemaphore), [`asyncio.Queue`](../library/asyncio-queue.md#asyncio.Queue),
  [`asyncio.create_subprocess_exec()`](../library/asyncio-subprocess.md#asyncio.create_subprocess_exec), and
  [`asyncio.create_subprocess_shell()`](../library/asyncio-subprocess.md#asyncio.create_subprocess_shell).
...
* The following functions and methods are deprecated in the [`gettext`](../library/gettext.md#module-gettext)
  ...
  `NullTranslations.set_output_charset()`, and the *codeset*
  parameter of functions [`translation()`](../library/gettext.md#gettext.translation) and
  [`install()`](../library/gettext.md#gettext.install) are also deprecated, since they are only used for
...
* Many builtin and extension functions that take integer arguments will
  now emit a deprecation warning for [`Decimal`](../library/decimal.md#decimal.Decimal)s,
  [`Fraction`](../library/fractions.md#fractions.Fraction)s and any other objects that can be converted
  to integers only with a loss (e.g. that have the [`__int__()`](../reference/datamodel.md#object.__int__)
  method but do not have the [`__index__()`](../reference/datamodel.md#object.__index__) method).  In future
...
* Deprecated passing the following arguments as keyword arguments:
  - *func* in [`functools.partialmethod()`](../library/functools.md#functools.partialmethod), [`weakref.finalize()`](../library/weakref.md#weakref.finalize),
    [`profile.Profile.runcall()`](../library/profile.md#profile.Profile.runcall), `cProfile.Profile.runcall()`,
    [`bdb.Bdb.runcall()`](../library/bdb.md#bdb.Bdb.runcall), [`trace.Trace.runfunc()`](../library/trace.md#trace.Trace.runfunc) and
    [`curses.wrapper()`](../library/curses.md#curses.wrapper).
  - *function* in [`unittest.TestCase.addCleanup()`](../library/unittest.md#unittest.TestCase.addCleanup).
  - *fn* in the [`submit()`](../library/concurrent.futures.md#concurrent.futures.Executor.submit) method of
    [`concurrent.futures.ThreadPoolExecutor`](../library/concurrent.futures.md#concurrent.futures.ThreadPoolExecutor) and
    [`concurrent.futures.ProcessPoolExecutor`](../library/concurrent.futures.md#concurrent.futures.ProcessPoolExecutor).
  - *callback* in [`contextlib.ExitStack.callback()`](../library/contextlib.md#contextlib.ExitStack.callback),
    `contextlib.AsyncExitStack.callback()` and
    [`contextlib.AsyncExitStack.push_async_callback()`](../library/contextlib.md#contextlib.AsyncExitStack.push_async_callback).
  - *c* and *typeid* in the `create()`
    method of `multiprocessing.managers.Server` and
    `multiprocessing.managers.SharedMemoryServer`.
  - *obj* in [`weakref.finalize()`](../library/weakref.md#weakref.finalize).

  In future releases of Python, they will be [positional-only](../glossary.md#positional-only-parameter).
...
* Starting with Python 3.3, importing ABCs from [`collections`](../library/collections.md#module-collections) was
  deprecated, and importing should be done from [`collections.abc`](../library/collections.abc.md#module-collections.abc). Being
...
* The function `platform.popen()` has been removed, after having been
  deprecated since Python 3.3: use [`os.popen()`](../library/os.md#os.popen) instead.
...
* The function `time.clock()` has been removed, after having been
  deprecated since Python 3.3: use [`time.perf_counter()`](../library/time.md#time.perf_counter) or
  [`time.process_time()`](../library/time.md#time.process_time) instead, depending
...
* `filemode` function is removed from the [`tarfile`](../library/tarfile.md#module-tarfile) module.
  It is not documented and deprecated since Python 3.3.
* The [`XMLParser`](../library/xml.etree.elementtree.md#xml.etree.ElementTree.XMLParser) constructor no longer accepts
  the *html* argument.  It never had an effect and was deprecated in Python 3.4.
  All other parameters are now [keyword-only](../glossary.md#keyword-only-parameter).
  (Contributed by Serhiy Storchaka in [bpo-29209](https://bugs.python.org/issue?@action=redirect&bpo=29209).)
* Removed the `doctype()` method of [`XMLParser`](../library/xml.etree.elementtree.md#xml.etree.ElementTree.XMLParser).
  (Contributed by Serhiy Storchaka in [bpo-29209](https://bugs.python.org/issue?@action=redirect&bpo=29209).)
...
* The `Cache` and `Statement` objects of the [`sqlite3`](../library/sqlite3.md#module-sqlite3) module are not
  exposed to the user.
  (Contributed by Aviv Palivoda in [bpo-30262](https://bugs.python.org/issue?@action=redirect&bpo=30262).)
* The `bufsize` keyword argument of [`fileinput.input()`](../library/fileinput.md#fileinput.input) and
  [`fileinput.FileInput()`](../library/fileinput.md#fileinput.FileInput) which was ignored and deprecated since Python 3.6
...
* The compiler now produces a [`SyntaxWarning`](../library/exceptions.md#SyntaxWarning) when identity checks
...
* Removed `__str__` implementations from builtin types [`bool`](../library/functions.md#bool),
  [`int`](../library/functions.md#int), [`float`](../library/functions.md#float), [`complex`](../library/functions.md#complex) and few classes from
  the standard library.  They now inherit `__str__()` from [`object`](../library/functions.md#object).
...
* On AIX, [`sys.platform`](../library/sys.md#sys.platform) doesn’t contain the major version anymore.
...
* `PyEval_AcquireLock()` and `PyEval_AcquireThread()` now
  ...
  finalizing, making them consistent with [`PyEval_RestoreThread()`](../c-api/threads.md#c.PyEval_RestoreThread),
  [`Py_END_ALLOW_THREADS()`](../c-api/threads.md#c.Py_END_ALLOW_THREADS), and [`PyGILState_Ensure()`](../c-api/threads.md#c.PyGILState_Ensure). If this
  behavior is not desired, guard the call by checking `_Py_IsFinalizing()`
  or [`sys.is_finalizing()`](../library/sys.md#sys.is_finalizing).
  (Contributed by Joannah Nanjekye in [bpo-36475](https://bugs.python.org/issue?@action=redirect&bpo=36475).)

### Changes in the Python API

* The [`os.getcwdb()`](../library/os.md#os.getcwdb) function now uses the UTF-8 encoding on Windows,
...
* [`subprocess.Popen`](../library/subprocess.md#subprocess.Popen) can now use [`os.posix_spawn()`](../library/os.md#os.posix_spawn) in some cases
  for better performance. On Windows Subsystem for Linux and QEMU User
  Emulation, the [`Popen`](../library/subprocess.md#subprocess.Popen) constructor using
  [`os.posix_spawn()`](../library/os.md#os.posix_spawn) no longer raises an exception on errors like
  “missing program”.  Instead the child process fails with a
  non-zero [`returncode`](../library/subprocess.md#subprocess.Popen.returncode).
  (Contributed by Joannah Nanjekye and Victor Stinner in [bpo-35537](https://bugs.python.org/issue?@action=redirect&bpo=35537).)
* The *preexec_fn* argument of \* [`subprocess.Popen`](../library/subprocess.md#subprocess.Popen) is no longer
  compatible with subinterpreters. The use of the parameter in a
  subinterpreter now raises [`RuntimeError`](../library/exceptions.md#RuntimeError).
...
* The [`imaplib.IMAP4.logout()`](../library/imaplib.md#imaplib.IMAP4.logout) method no longer silently ignores arbitrary
  exceptions.
...
* The function `platform.popen()` has been removed, after having been deprecated since
  Python 3.3: use [`os.popen()`](../library/os.md#os.popen) instead.
  (Contributed by Victor Stinner in [bpo-35345](https://bugs.python.org/issue?@action=redirect&bpo=35345).)
* The [`statistics.mode()`](../library/statistics.md#statistics.mode) function no longer raises an exception
...
* The [`selection()`](../library/tkinter.ttk.md#tkinter.ttk.Treeview.selection) method of the
  [`tkinter.ttk.Treeview`](../library/tkinter.ttk.md#tkinter.ttk.Treeview) class no longer takes arguments.  Using it with
  arguments for changing the selection was deprecated in Python 3.6.  Use
  specialized methods like [`selection_set()`](../library/tkinter.ttk.md#tkinter.ttk.Treeview.selection_set) for
...
* The [`writexml()`](../library/xml.dom.minidom.md#xml.dom.minidom.Node.writexml), [`toxml()`](../library/xml.dom.minidom.md#xml.dom.minidom.Node.toxml)
  and [`toprettyxml()`](../library/xml.dom.minidom.md#xml.dom.minidom.Node.toprettyxml) methods of
  [`xml.dom.minidom`](../library/xml.dom.minidom.md#module-xml.dom.minidom) and the [`write()`](../library/xml.etree.elementtree.md#xml.etree.ElementTree.ElementTree.write)
  method of [`xml.etree.ElementTree`](../library/xml.etree.elementtree.md#module-xml.etree.ElementTree) now preserve the attribute order
  specified by the user.
  (Contributed by Diego Rojas and Raymond Hettinger in [bpo-34160](https://bugs.python.org/issue?@action=redirect&bpo=34160).)
* A [`dbm.dumb`](../library/dbm.md#module-dbm.dumb) database opened with flags `'r'` is now read-only.
  [`dbm.dumb.open()`](../library/dbm.md#dbm.dumb.open) with flags `'r'` and `'w'` no longer creates
...
* The `doctype()` method defined in a subclass of
  [`XMLParser`](../library/xml.etree.elementtree.md#xml.etree.ElementTree.XMLParser) will no longer be called and will
  emit a [`RuntimeWarning`](../library/exceptions.md#RuntimeWarning) instead of a [`DeprecationWarning`](../library/exceptions.md#DeprecationWarning).
  Define the [`doctype()`](../library/xml.etree.elementtree.md#xml.etree.ElementTree.TreeBuilder.doctype)
  method on a target for handling an XML doctype declaration.
  (Contributed by Serhiy Storchaka in [bpo-29209](https://bugs.python.org/issue?@action=redirect&bpo=29209).)
* A [`RuntimeError`](../library/exceptions.md#RuntimeError) is now raised when the custom metaclass doesn’t
  provide the `__classcell__` entry in the namespace passed to
  `type.__new__`.  A [`DeprecationWarning`](../library/exceptions.md#DeprecationWarning) was emitted in Python
  3.6–3.7.  (Contributed by Serhiy Storchaka in [bpo-23722](https://bugs.python.org/issue?@action=redirect&bpo=23722).)
* The [`cProfile.Profile`](../library/profile.md#profile.Profile) class can now be used as
  a context manager. (Contributed by Scott Sanderson in [bpo-29235](https://bugs.python.org/issue?@action=redirect&bpo=29235).)
* [`shutil.copyfile()`](../library/shutil.md#shutil.copyfile), [`shutil.copy()`](../library/shutil.md#shutil.copy), [`shutil.copy2()`](../library/shutil.md#shutil.copy2),
  [`shutil.copytree()`](../library/shutil.md#shutil.copytree) and [`shutil.move()`](../library/shutil.md#shutil.move) use platform-specific
  “fast-copy” syscalls (see
  [Platform-dependent efficient copy operations](../library/shutil.md#shutil-platform-dependent-efficient-copy-operations) section).
* [`shutil.copyfile()`](../library/shutil.md#shutil.copyfile) default buffer size on Windows was changed from
  16 KiB to 1 MiB.
...
* The [`PyInterpreterState`](../c-api/subinterpreters.md#c.PyInterpreterState) struct has been moved into the “internal”
...
* The [`mmap.flush()`](../library/mmap.md#mmap.mmap.flush) method now returns `None` on
...
* [`xml.dom.minidom`](../library/xml.dom.minidom.md#module-xml.dom.minidom) and [`xml.sax`](../library/xml.sax.md#module-xml.sax) modules no longer process
  external entities by default.
  (Contributed by Christian Heimes in [bpo-17239](https://bugs.python.org/issue?@action=redirect&bpo=17239).)
* Deleting a key from a read-only [`dbm`](../library/dbm.md#module-dbm) database ([`dbm.dumb`](../library/dbm.md#module-dbm.dumb),
  [`dbm.gnu`](../library/dbm.md#module-dbm.gnu) or [`dbm.ndbm`](../library/dbm.md#module-dbm.ndbm)) raises `error` ([`dbm.dumb.error`](../library/dbm.md#dbm.dumb.error),
  [`dbm.gnu.error`](../library/dbm.md#dbm.gnu.error) or [`dbm.ndbm.error`](../library/dbm.md#dbm.ndbm.error)) instead of [`KeyError`](../library/exceptions.md#KeyError).
...
* Simplified AST for literals.  All constants will be represented as
  [`ast.Constant`](../library/ast.md#ast.Constant) instances.  Instantiating old classes `Num`,
...
* The exception [`asyncio.CancelledError`](../library/asyncio-exceptions.md#asyncio.CancelledError) now inherits from
  ...
  from [`concurrent.futures.CancelledError`](../library/concurrent.futures.md#concurrent.futures.CancelledError).
  (Contributed by Yury Selivanov in [bpo-32528](https://bugs.python.org/issue?@action=redirect&bpo=32528).)
* The function [`asyncio.wait_for()`](../library/asyncio-task.md#asyncio.wait_for) now correctly waits for cancellation
  when using an instance of [`asyncio.Task`](../library/asyncio-task.md#asyncio.Task). Previously, upon reaching
...
* The function [`asyncio.BaseTransport.get_extra_info()`](../library/asyncio-protocol.md#asyncio.BaseTransport.get_extra_info) now returns a safe
...
* [`asyncio.BufferedProtocol`](../library/asyncio-protocol.md#asyncio.BufferedProtocol) has graduated to the stable API.

<a id="bpo-36085-whatsnew"></a>
* DLL dependencies for extension modules and DLLs loaded with [`ctypes`](../library/ctypes.md#module-ctypes) on
  ...
  [`add_dll_directory()`](../library/os.md#os.add_dll_directory) are searched for load-time dependencies.
  ...
  for [`add_dll_directory()`](../library/os.md#os.add_dll_directory) and if it exists, use it to add your DLLs
...
* [`types.CodeType`](../library/types.md#types.CodeType) has a new parameter in the second position of the
  ...
  `replace()` method of [`types.CodeType`](../library/types.md#types.CodeType) can be used to make the code
  future-proof.
* The parameter `digestmod` for [`hmac.new()`](../library/hmac.md#hmac.new) no longer uses the MD5 digest
  by default.

### Changes in the C API

* The [`PyCompilerFlags`](../c-api/veryhigh.md#c.PyCompilerFlags) structure got a new *cf_feature_version*
...
* The `PyEval_ReInitThreads()` function has been removed from the C API.
  It should not be called explicitly: use [`PyOS_AfterFork_Child()`](../c-api/sys.md#c.PyOS_AfterFork_Child)
  instead.
...
* Use of `#` variants of formats in parsing or building value (e.g.
  [`PyArg_ParseTuple()`](../c-api/arg.md#c.PyArg_ParseTuple), [`Py_BuildValue()`](../c-api/arg.md#c.Py_BuildValue), [`PyObject_CallFunction()`](../c-api/call.md#c.PyObject_CallFunction),
  etc.) without `PY_SSIZE_T_CLEAN` defined raises `DeprecationWarning` now.
  It will be removed in 3.10 or 4.0.  Read [Parsing arguments and building values](../c-api/arg.md#arg-parsing) for detail.
  (Contributed by Inada Naoki in [bpo-36381](https://bugs.python.org/issue?@action=redirect&bpo=36381).)
* Instances of heap-allocated types (such as those created with
  [`PyType_FromSpec()`](../c-api/type.md#c.PyType_FromSpec)) hold a reference to their type object.
  Increasing the reference count of these type objects has been moved from
  [`PyType_GenericAlloc()`](../c-api/type.md#c.PyType_GenericAlloc) to the more low-level functions,
  [`PyObject_Init()`](../c-api/allocation.md#c.PyObject_Init) and `PyObject_INIT`.
  This makes types created through [`PyType_FromSpec()`](../c-api/type.md#c.PyType_FromSpec) behave like
  other classes in managed code.

  [Statically allocated types](../c-api/typeobj.md#static-types) are not affected.
  ...
  changes:
  * Remove [`Py_INCREF`](../c-api/refcounting.md#c.Py_INCREF) on the type object after allocating an
    instance - if any.
    This may happen after calling [`PyObject_New`](../c-api/allocation.md#c.PyObject_New),
    [`PyObject_NewVar`](../c-api/allocation.md#c.PyObject_NewVar), [`PyObject_GC_New()`](../c-api/gcsupport.md#c.PyObject_GC_New),
    [`PyObject_GC_NewVar()`](../c-api/gcsupport.md#c.PyObject_GC_NewVar), or any other custom allocator that uses
    [`PyObject_Init()`](../c-api/allocation.md#c.PyObject_Init) or `PyObject_INIT`.
  ...
  * Ensure that all custom `tp_dealloc` functions of heap-allocated types
  ...
  (Contributed by Eddie Elizondo in [bpo-35810](https://bugs.python.org/issue?@action=redirect&bpo=35810).)
* The [`Py_DEPRECATED()`](../c-api/intro.md#c.Py_DEPRECATED) macro has been implemented for MSVC.
...
* The interpreter does not pretend to support binary compatibility of
  extension types across feature releases, anymore.  A [`PyTypeObject`](../c-api/type.md#c.PyTypeObject)
  ...
  [`tp_finalize`](../c-api/typeobj.md#c.PyTypeObject.tp_finalize) ([`Py_TPFLAGS_HAVE_FINALIZE`](../c-api/typeobj.md#c.Py_TPFLAGS_HAVE_FINALIZE)
  is not checked anymore before reading [`tp_finalize`](../c-api/typeobj.md#c.PyTypeObject.tp_finalize)).
...
* The `libpython38.a` file to allow MinGW tools to link directly against
  ...
  [Using Python on Windows](../using/windows.md#using-on-windows) for more information. The resulting library should be
...
* The interpreter loop  has been simplified by moving the logic of unrolling
  ...
  cleaning-up code for [`break`](../reference/simple_stmts.md#break), [`continue`](../reference/simple_stmts.md#continue) and
  [`return`](../reference/simple_stmts.md#return).
...
* Added new opcode [`END_ASYNC_FOR`](../library/dis.md#opcode-END_ASYNC_FOR) for handling exceptions raised
  when awaiting a next item in an [`async for`](../reference/compound_stmts.md#async-for) loop.
  (Contributed by Serhiy Storchaka in [bpo-33041](https://bugs.python.org/issue?@action=redirect&bpo=33041).)
* The [`MAP_ADD`](../library/dis.md#opcode-MAP_ADD) now expects the value as the first element in the
...
Fixed a regression with the `ignore` callback of [`shutil.copytree()`](../library/shutil.md#shutil.copytree).
...
Starting with Python 3.8.12 the [`ipaddress`](../library/ipaddress.md#module-ipaddress) module no longer accepts
any leading zeros in IPv4 address strings. Leading zeros are ambiguous and
interpreted as octal notation by some libraries. For example the legacy
function [`socket.inet_aton()`](../library/socket.md#socket.inet_aton) treats leading zeros as octal notation.
glibc implementation of modern [`inet_pton()`](../library/socket.md#socket.inet_pton) does not accept
any leading zeros.
