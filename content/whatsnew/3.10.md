...
[`SyntaxError`](../library/exceptions.md#SyntaxError) exceptions raised by the interpreter will now highlight the
...
A considerable amount of new specialized messages for [`SyntaxError`](../library/exceptions.md#SyntaxError) exceptions
...
Many [`IndentationError`](../library/exceptions.md#IndentationError) exceptions now have more context regarding what kind of block
...
When printing [`AttributeError`](../library/exceptions.md#AttributeError), `PyErr_Display()` will offer
...
When printing [`NameError`](../library/exceptions.md#NameError) raised by the interpreter, `PyErr_Display()`
...
The [`f_lineno`](../reference/datamodel.md#frame.f_lineno) attribute of frame objects will always contain the
expected line number.

The [`co_lnotab`](../reference/datamodel.md#codeobject.co_lnotab) attribute of
[code objects](../reference/datamodel.md#code-objects) is deprecated and
will be removed in 3.12.
Code that needs to convert from offset to line number should use the new
[`co_lines()`](../reference/datamodel.md#codeobject.co_lines) method instead.
...
<a id="whatsnew310-pep597"></a>

### Optional `EncodingWarning` and `encoding="locale"` option

The default encoding of [`TextIOWrapper`](../library/io.md#io.TextIOWrapper) and [`open()`](../library/functions.md#open) is
...
It is emitted when [`sys.flags.warn_default_encoding`](../library/sys.md#sys.flags)
is true and locale-specific default encoding is used.

`-X warn_default_encoding` option and [`PYTHONWARNDEFAULTENCODING`](../using/cmdline.md#envvar-PYTHONWARNDEFAULTENCODING)
are added to enable the warning.

See [Text Encoding](../library/io.md#io-text-encoding) for more information.

<a id="new-feat-related-type-hints"></a>
...
using [`typing.Union`](../library/typing.md#typing.Union), especially in type hints.

In previous versions of Python, to apply a type hint for functions accepting
arguments of multiple types, [`typing.Union`](../library/typing.md#typing.Union) was used:
...
This new syntax is also accepted as the second argument to [`isinstance()`](../library/functions.md#isinstance)
and [`issubclass()`](../library/functions.md#issubclass):
...
See [Union Type](../library/stdtypes.md#types-union) and [**PEP 604**](https://peps.python.org/pep-0604/) for more details.
...
[**PEP 484**](https://peps.python.org/pep-0484/)‘s `Callable` have been added to the [`typing`](../library/typing.md#module-typing) module.
...
in [`typing.ParamSpec`](../library/typing.md#typing.ParamSpec). Previously, there was no easy way to type annotate
...
be found in [`typing.Concatenate`](../library/typing.md#typing.Concatenate).

See [`typing.Callable`](../library/typing.md#typing.Callable), [`typing.ParamSpec`](../library/typing.md#typing.ParamSpec),
[`typing.Concatenate`](../library/typing.md#typing.Concatenate), [`typing.ParamSpecArgs`](../library/typing.md#typing.ParamSpecArgs),
[`typing.ParamSpecKwargs`](../library/typing.md#typing.ParamSpecKwargs), and [**PEP 612**](https://peps.python.org/pep-0612/) for more details.
...
Now the [`typing`](../library/typing.md#module-typing) module has a special value [`TypeAlias`](../library/typing.md#typing.TypeAlias)
...
[`TypeGuard`](../library/typing.md#typing.TypeGuard) has been added to the [`typing`](../library/typing.md#module-typing) module to annotate
...
[`TypeGuard`](../library/typing.md#typing.TypeGuard)‘s documentation, and [**PEP 647**](https://peps.python.org/pep-0647/).
...
* The [`int`](../library/functions.md#int) type has a new method [`int.bit_count()`](../library/stdtypes.md#int.bit_count), returning the
...
* The views returned by [`dict.keys()`](../library/stdtypes.md#dict.keys), [`dict.values()`](../library/stdtypes.md#dict.values) and
  [`dict.items()`](../library/stdtypes.md#dict.items) now all have a `mapping` attribute that gives a
  [`types.MappingProxyType`](../library/types.md#types.MappingProxyType) object wrapping the original
  dictionary. (Contributed by Dennis Sweeney in [bpo-40890](https://bugs.python.org/issue?@action=redirect&bpo=40890).)
* [**PEP 618**](https://peps.python.org/pep-0618/): The [`zip()`](../library/functions.md#zip) function now has an optional `strict` flag, used
  to require that all the iterables have an equal length.
* Builtin and extension functions that take integer arguments no longer accept
  [`Decimal`](../library/decimal.md#decimal.Decimal)s, [`Fraction`](../library/fractions.md#fractions.Fraction)s and other
  objects that can be converted to integers only with a loss (e.g. that have
  the [`__int__()`](../reference/datamodel.md#object.__int__) method but do not have the
  [`__index__()`](../reference/datamodel.md#object.__index__) method).
  (Contributed by Serhiy Storchaka in [bpo-37999](https://bugs.python.org/issue?@action=redirect&bpo=37999).)
* If [`object.__ipow__()`](../reference/datamodel.md#object.__ipow__) returns [`NotImplemented`](../library/constants.md#NotImplemented), the operator will
  correctly fall back to [`object.__pow__()`](../reference/datamodel.md#object.__pow__) and [`object.__rpow__()`](../reference/datamodel.md#object.__rpow__) as expected.
...
* Two new builtin functions – [`aiter()`](../library/functions.md#aiter) and [`anext()`](../library/functions.md#anext) have been added
  to provide asynchronous counterparts to [`iter()`](../library/functions.md#iter) and [`next()`](../library/functions.md#next),
  respectively.
...
* Static methods ([`@staticmethod`](../library/functions.md#staticmethod)) and class methods
  ([`@classmethod`](../library/functions.md#classmethod)) now inherit the method attributes
...
* Class and module objects now lazy-create empty annotations dicts on demand.
  ...
  [Annotations Best Practices](../howto/annotations.md#annotations-howto).
...
* Usage of unbound variables, `super()` and other expressions that might
  ...
  (Contributed by Batuhan Taskaya in [bpo-42725](https://bugs.python.org/issue?@action=redirect&bpo=42725).)
* Hashes of NaN values of both [`float`](../library/functions.md#float) type and
  [`decimal.Decimal`](../library/decimal.md#decimal.Decimal) type now depend on object identity. Formerly, they
...
* A [`SyntaxError`](../library/exceptions.md#SyntaxError) (instead of a [`NameError`](../library/exceptions.md#NameError)) will be raised when deleting
  the [`__debug__`](../library/constants.md#debug__) constant.  (Contributed by Donghee Na in [bpo-45000](https://bugs.python.org/issue?@action=redirect&bpo=45000).)
* [`SyntaxError`](../library/exceptions.md#SyntaxError) exceptions now have `end_lineno` and
...
Add missing [`connect_accepted_socket()`](../library/asyncio-eventloop.md#asyncio.loop.connect_accepted_socket)
method.
...
The [`index()`](../library/array.md#array.array.index) method of [`array.array`](../library/array.md#array.array) now has
...
since Python 3.6.  An import-time [`DeprecationWarning`](../library/exceptions.md#DeprecationWarning) has now been
added to all three of these modules.

### base64

Add [`base64.b32hexencode()`](../library/base64.md#base64.b32hexencode) and [`base64.b32hexdecode()`](../library/base64.md#base64.b32hexdecode) to support the
...
Added the possibility of providing a *key* function to the APIs in the [`bisect`](../library/bisect.md#module-bisect)
module. (Contributed by Raymond Hettinger in [bpo-4356](https://bugs.python.org/issue?@action=redirect&bpo=4356).)

### codecs

Add a [`codecs.unregister()`](../library/codecs.md#codecs.unregister) function to unregister a codec search function.
(Contributed by Hai Shi in [bpo-41842](https://bugs.python.org/issue?@action=redirect&bpo=41842).)

### collections.abc

The `__args__` of the [parameterized generic](../library/stdtypes.md#types-genericalias) for
[`collections.abc.Callable`](../library/collections.abc.md#collections.abc.Callable) are now consistent with [`typing.Callable`](../library/typing.md#typing.Callable).
...
be returned when subscripting the [`collections.abc.Callable`](../library/collections.abc.md#collections.abc.Callable) type.  Note
that a [`TypeError`](../library/exceptions.md#TypeError) may be raised for invalid forms of parameterizing
[`collections.abc.Callable`](../library/collections.abc.md#collections.abc.Callable) which may have passed silently in Python 3.9.
(Contributed by Ken Jin in [bpo-42195](https://bugs.python.org/issue?@action=redirect&bpo=42195).)

### contextlib

Add a [`contextlib.aclosing()`](../library/contextlib.md#contextlib.aclosing) context manager to safely close async generators
...
Add asynchronous context manager support to [`contextlib.nullcontext()`](../library/contextlib.md#contextlib.nullcontext).
(Contributed by Tom Gringauz in [bpo-41543](https://bugs.python.org/issue?@action=redirect&bpo=41543).)

Add [`AsyncContextDecorator`](../library/contextlib.md#contextlib.AsyncContextDecorator), for supporting usage of async
context managers as decorators.

### curses

The extended color functions added in ncurses 6.1 will be used transparently
by [`curses.color_content()`](../library/curses.md#curses.color_content), [`curses.init_color()`](../library/curses.md#curses.init_color),
[`curses.init_pair()`](../library/curses.md#curses.init_pair), and [`curses.pair_content()`](../library/curses.md#curses.pair_content). A new function,
[`curses.has_extended_color_support()`](../library/curses.md#curses.has_extended_color_support), indicates whether extended color
...
The `BUTTON5_*` constants are now exposed in the [`curses`](../library/curses.md#module-curses) module if
...
Added `slots` parameter in [`dataclasses.dataclass()`](../library/dataclasses.md#dataclasses.dataclass) decorator.
...
generated \_\_init_\_ method.  There are a number of ways of specifying
keyword-only fields.
...
in the standard library (such as [`platform`](../library/platform.md#module-platform), [`shutil`](../library/shutil.md#module-shutil),
[`subprocess`](../library/subprocess.md#module-subprocess) or [`sysconfig`](../library/sysconfig.md#module-sysconfig)). There are no plans to migrate
...
[`encodings.normalize_encoding()`](../library/codecs.md#encodings.normalize_encoding) now ignores non-ASCII characters.
(Contributed by Hai Shi in [bpo-39337](https://bugs.python.org/issue?@action=redirect&bpo=39337).)

### enum

[`Enum`](../library/enum.md#enum.Enum) [`__repr__()`](../reference/datamodel.md#object.__repr__) now returns `enum_name.member_name` and
[`__str__()`](../reference/datamodel.md#object.__str__) now returns `member_name`.  Stdlib enums available as
module constants have a [`repr()`](../library/functions.md#repr) of `module_name.member_name`.
(Contributed by Ethan Furman in [bpo-40066](https://bugs.python.org/issue?@action=redirect&bpo=40066).)

Add [`enum.StrEnum`](../library/enum.md#enum.StrEnum) for enums where all members are strings.
(Contributed by Ethan Furman in [bpo-41816](https://bugs.python.org/issue?@action=redirect&bpo=41816).)

### fileinput

Add *encoding* and *errors* parameters in [`fileinput.input()`](../library/fileinput.md#fileinput.input) and
[`fileinput.FileInput`](../library/fileinput.md#fileinput.FileInput).
(Contributed by Inada Naoki in [bpo-43712](https://bugs.python.org/issue?@action=redirect&bpo=43712).)

[`fileinput.hook_compressed()`](../library/fileinput.md#fileinput.hook_compressed) now returns [`TextIOWrapper`](../library/io.md#io.TextIOWrapper) object
...
The [`faulthandler`](../library/faulthandler.md#module-faulthandler) module now detects if a fatal error occurs during a
...
Add audit hooks for [`gc.get_objects()`](../library/gc.md#gc.get_objects), [`gc.get_referrers()`](../library/gc.md#gc.get_referrers) and
[`gc.get_referents()`](../library/gc.md#gc.get_referents). (Contributed by Pablo Galindo in [bpo-43439](https://bugs.python.org/issue?@action=redirect&bpo=43439).)

### glob

Add the *root_dir* and *dir_fd* parameters in [`glob()`](../library/glob.md#glob.glob) and
[`iglob()`](../library/glob.md#glob.iglob) which allow to specify the root directory for searching.
...
The pure-Python fallback of [`pbkdf2_hmac()`](../library/hashlib.md#hashlib.pbkdf2_hmac) is deprecated. In
...
Highlight the new [soft keywords](../reference/lexical_analysis.md#soft-keywords) [`match`](../reference/compound_stmts.md#match),
...
[importlib.metadata entry points](../library/importlib.metadata.md#entry-points)
now provide a nicer experience
for selecting entry points by group and name through a new
[importlib.metadata.EntryPoints](../library/importlib.metadata.md#entry-points) class. See the Compatibility
Note in the docs for more info on the deprecation and usage.

Added [importlib.metadata.packages_distributions()](../library/importlib.metadata.md#package-distributions)
for resolving top-level Python modules and packages to their
[importlib.metadata.Distribution](../library/importlib.metadata.md#distributions).
...
Add [`inspect.get_annotations()`](../library/inspect.md#inspect.get_annotations), which safely computes the annotations
...
it examines. [`inspect.get_annotations()`](../library/inspect.md#inspect.get_annotations) can also correctly un-stringize
stringized annotations.  [`inspect.get_annotations()`](../library/inspect.md#inspect.get_annotations) is now considered
...
[Annotations Best Practices](../howto/annotations.md#annotations-howto).
Relatedly, [`inspect.signature()`](../library/inspect.md#inspect.signature),
[`inspect.Signature.from_callable()`](../library/inspect.md#inspect.Signature.from_callable), and `inspect.Signature.from_function()`
now call [`inspect.get_annotations()`](../library/inspect.md#inspect.get_annotations) to retrieve annotations. This means
[`inspect.signature()`](../library/inspect.md#inspect.signature) and [`inspect.Signature.from_callable()`](../library/inspect.md#inspect.Signature.from_callable) can
...
Add [`itertools.pairwise()`](../library/itertools.md#itertools.pairwise).
...
Add [`os.cpu_count()`](../library/os.md#os.cpu_count) support for VxWorks RTOS.
(Contributed by Peixing Xin in [bpo-41440](https://bugs.python.org/issue?@action=redirect&bpo=41440).)

Add a new function [`os.eventfd()`](../library/os.md#os.eventfd) and related helpers to wrap the
...
Add [`os.splice()`](../library/os.md#os.splice) that allows to move data between two file
...
Add [`O_EVTONLY`](../library/os.md#os.O_EVTONLY), [`O_FSYNC`](../library/os.md#os.O_FSYNC), [`O_SYMLINK`](../library/os.md#os.O_SYMLINK)
and [`O_NOFOLLOW_ANY`](../library/os.md#os.O_NOFOLLOW_ANY) for macOS.
(Contributed by Donghee Na in [bpo-43106](https://bugs.python.org/issue?@action=redirect&bpo=43106).)

### os.path

[`os.path.realpath()`](../library/os.path.md#os.path.realpath) now accepts a *strict* keyword-only argument. When set
to `True`, [`OSError`](../library/exceptions.md#OSError) is raised if a path doesn’t exist or a symlink loop
is encountered.
(Contributed by Barney Gale in [bpo-43757](https://bugs.python.org/issue?@action=redirect&bpo=43757).)

### pathlib

Add slice support to [`PurePath.parents`](../library/pathlib.md#pathlib.PurePath.parents).
(Contributed by Joshua Cannon in [bpo-35498](https://bugs.python.org/issue?@action=redirect&bpo=35498).)

Add negative indexing support to [`PurePath.parents`](../library/pathlib.md#pathlib.PurePath.parents).
(Contributed by Yaroslav Pankovych in [bpo-21041](https://bugs.python.org/issue?@action=redirect&bpo=21041).)

Add [`Path.hardlink_to`](../library/pathlib.md#pathlib.Path.hardlink_to) method that
supersedes `link_to()`. The new method has the same argument
order as [`symlink_to()`](../library/pathlib.md#pathlib.Path.symlink_to).
(Contributed by Barney Gale in [bpo-39950](https://bugs.python.org/issue?@action=redirect&bpo=39950).)

[`pathlib.Path.stat()`](../library/pathlib.md#pathlib.Path.stat) and [`chmod()`](../library/pathlib.md#pathlib.Path.chmod) now accept a
*follow_symlinks* keyword-only argument for consistency with corresponding
functions in the [`os`](../library/os.md#module-os) module.
(Contributed by Barney Gale in [bpo-39906](https://bugs.python.org/issue?@action=redirect&bpo=39906).)

### platform

Add [`platform.freedesktop_os_release()`](../library/platform.md#platform.freedesktop_os_release) to retrieve operation system
...
[`pprint.pprint()`](../library/pprint.md#pprint.pprint) now accepts a new `underscore_numbers` keyword argument.
(Contributed by sblondon in [bpo-42914](https://bugs.python.org/issue?@action=redirect&bpo=42914).)

[`pprint`](../library/pprint.md#module-pprint) can now pretty-print [`dataclasses.dataclass`](../library/dataclasses.md#dataclasses.dataclass) instances.
(Contributed by Lewis Gaul in [bpo-43080](https://bugs.python.org/issue?@action=redirect&bpo=43080).)

### py_compile

Add `--quiet` option to command-line interface of [`py_compile`](../library/py_compile.md#module-py_compile).
...
objects in the tree returned by [`pyclbr.readmodule()`](../library/pyclbr.md#pyclbr.readmodule) and
[`pyclbr.readmodule_ex()`](../library/pyclbr.md#pyclbr.readmodule_ex).  It matches the existing (start) `lineno`.
(Contributed by Aviral Srivastava in [bpo-38307](https://bugs.python.org/issue?@action=redirect&bpo=38307).)

### shelve

The [`shelve`](../library/shelve.md#module-shelve) module now uses [`pickle.DEFAULT_PROTOCOL`](../library/pickle.md#pickle.DEFAULT_PROTOCOL) by default
instead of [`pickle`](../library/pickle.md#module-pickle) protocol `3` when creating shelves.
(Contributed by Zackery Spytz in [bpo-34204](https://bugs.python.org/issue?@action=redirect&bpo=34204).)

### statistics

Add [`covariance()`](../library/statistics.md#statistics.covariance), Pearson’s
[`correlation()`](../library/statistics.md#statistics.correlation), and simple
[`linear_regression()`](../library/statistics.md#statistics.linear_regression) functions.
...
The exception [`socket.timeout`](../library/socket.md#socket.timeout) is now an alias of [`TimeoutError`](../library/exceptions.md#TimeoutError).
...
[`OP_IGNORE_UNEXPECTED_EOF`](../library/ssl.md#ssl.OP_IGNORE_UNEXPECTED_EOF).
...
a [`DeprecationWarning`](../library/exceptions.md#DeprecationWarning). [`ssl.SSLContext.options`](../library/ssl.md#ssl.SSLContext.options) has
[`OP_NO_SSLv2`](../library/ssl.md#ssl.OP_NO_SSLv2) and [`OP_NO_SSLv3`](../library/ssl.md#ssl.OP_NO_SSLv3) set by default and
...
[`SSLContext`](../library/ssl.md#ssl.SSLContext) defaults to minimum protocol version TLS 1.2.
...
Add a *timeout* parameter to the [`ssl.get_server_certificate()`](../library/ssl.md#ssl.get_server_certificate) function.
...
A new verify flag [`VERIFY_X509_PARTIAL_CHAIN`](../library/ssl.md#ssl.VERIFY_X509_PARTIAL_CHAIN) has been added.
(Contributed by l0x in [bpo-40849](https://bugs.python.org/issue?@action=redirect&bpo=40849).)

### sqlite3

Add audit events for [`connect()`](../library/sqlite3.md#sqlite3.connect),
[`enable_load_extension()`](../library/sqlite3.md#sqlite3.Connection.enable_load_extension), and
[`load_extension()`](../library/sqlite3.md#sqlite3.Connection.load_extension).
(Contributed by Erlend E. Aasland in [bpo-43762](https://bugs.python.org/issue?@action=redirect&bpo=43762).)

### sys

Add [`sys.orig_argv`](../library/sys.md#sys.orig_argv) attribute: the list of the original command line
arguments passed to the Python executable.
(Contributed by Victor Stinner in [bpo-23427](https://bugs.python.org/issue?@action=redirect&bpo=23427).)

Add [`sys.stdlib_module_names`](../library/sys.md#sys.stdlib_module_names), containing the list of the standard library
module names.
(Contributed by Victor Stinner in [bpo-42955](https://bugs.python.org/issue?@action=redirect&bpo=42955).)

### \_thread

[`_thread.interrupt_main()`](../library/_thread.md#thread.interrupt_main) now takes an optional signal number to
simulate (the default is still [`signal.SIGINT`](../library/signal.md#signal.SIGINT)).
(Contributed by Antoine Pitrou in [bpo-43356](https://bugs.python.org/issue?@action=redirect&bpo=43356).)

### threading

Add [`threading.gettrace()`](../library/threading.md#threading.gettrace) and [`threading.getprofile()`](../library/threading.md#threading.getprofile) to
retrieve the functions set by [`threading.settrace()`](../library/threading.md#threading.settrace) and
[`threading.setprofile()`](../library/threading.md#threading.setprofile) respectively.
(Contributed by Mario Corchero in [bpo-42251](https://bugs.python.org/issue?@action=redirect&bpo=42251).)

Add [`threading.__excepthook__`](../library/threading.md#threading.__excepthook__) to allow retrieving the original value
of [`threading.excepthook()`](../library/threading.md#threading.excepthook) in case it is set to a broken or a different
value.
(Contributed by Mario Corchero in [bpo-42308](https://bugs.python.org/issue?@action=redirect&bpo=42308).)

### traceback

The [`format_exception()`](../library/traceback.md#traceback.format_exception),
[`format_exception_only()`](../library/traceback.md#traceback.format_exception_only), and
[`print_exception()`](../library/traceback.md#traceback.print_exception) functions can now take an exception object
...
Reintroduce the [`types.EllipsisType`](../library/types.md#types.EllipsisType), [`types.NoneType`](../library/types.md#types.NoneType)
and [`types.NotImplementedType`](../library/types.md#types.NotImplementedType) classes, providing a new set
...
Add new function [`typing.is_typeddict()`](../library/typing.md#typing.is_typeddict) to introspect if an annotation
is a [`typing.TypedDict`](../library/typing.md#typing.TypedDict).
...
are decorated with [`runtime_checkable()`](../library/typing.md#typing.runtime_checkable).  Previously, these checks
...
[`DeprecationWarning`](../library/exceptions.md#DeprecationWarning).  These submodules have been deprecated since
...
[`typing`](../library/typing.md#module-typing) instead.
(Contributed by Sebastian Rittau in [bpo-38291](https://bugs.python.org/issue?@action=redirect&bpo=38291).)

### unittest

Add new method [`assertNoLogs()`](../library/unittest.md#unittest.TestCase.assertNoLogs) to complement the
existing [`assertLogs()`](../library/unittest.md#unittest.TestCase.assertLogs). (Contributed by Kit Yan Choi
...
Add a [`LexicalHandler`](../library/xml.sax.handler.md#xml.sax.handler.LexicalHandler) class to the
[`xml.sax.handler`](../library/xml.sax.handler.md#module-xml.sax.handler) module.
(Contributed by Jonathan Gossage and Zackery Spytz in [bpo-35018](https://bugs.python.org/issue?@action=redirect&bpo=35018).)

### zipimport

Add methods related to [**PEP 451**](https://peps.python.org/pep-0451/): [`find_spec()`](../library/zipimport.md#zipimport.zipimporter.find_spec),
[`zipimport.zipimporter.create_module()`](../library/zipimport.md#zipimport.zipimporter.create_module), and
[`zipimport.zipimporter.exec_module()`](../library/zipimport.md#zipimport.zipimporter.exec_module).
(Contributed by Brett Cannon in [bpo-42131](https://bugs.python.org/issue?@action=redirect&bpo=42131).)

Add [`invalidate_caches()`](../library/zipimport.md#zipimport.zipimporter.invalidate_caches) method.
(Contributed by Desmond Cheong in [bpo-14678](https://bugs.python.org/issue?@action=redirect&bpo=14678).)

## Optimizations

* Constructors [`str()`](../library/stdtypes.md#str), [`bytes()`](../library/stdtypes.md#bytes) and [`bytearray()`](../library/stdtypes.md#bytearray) are now faster
...
* The [`runpy`](../library/runpy.md#module-runpy) module now imports fewer modules.
...
* The `LOAD_ATTR` instruction now uses new “per opcode cache” mechanism.  It
  ...
  and MicroPython.)
* When building Python with [`--enable-optimizations`](../using/configure.md#cmdoption-enable-optimizations) now
  `-fno-semantic-interposition` is added to both the compile and link line.
  This speeds builds of the Python interpreter created with [`--enable-shared`](../using/configure.md#cmdoption-enable-shared)
...
* Use a new output buffer management code for [`bz2`](../library/bz2.md#module-bz2) / [`lzma`](../library/lzma.md#module-lzma) /
  [`zlib`](../library/zlib.md#module-zlib) modules, and add `.readall()` function to
...
* The following built-in functions now support the faster [**PEP 590**](https://peps.python.org/pep-0590/) vectorcall calling convention:
  [`map()`](../library/functions.md#map), [`filter()`](../library/functions.md#filter), [`reversed()`](../library/functions.md#reversed), [`bool()`](../library/functions.md#bool) and [`float()`](../library/functions.md#float).
...
* [`BZ2File`](../library/bz2.md#bz2.BZ2File) performance is improved by removing internal `RLock`.
  This makes `BZ2File` thread unsafe in the face of multiple simultaneous
  readers or writers, just like its equivalent classes in [`gzip`](../library/gzip.md#module-gzip) and
  [`lzma`](../library/lzma.md#module-lzma) have always been.  (Contributed by Inada Naoki in [bpo-43785](https://bugs.python.org/issue?@action=redirect&bpo=43785).)

<a id="whatsnew310-deprecated"></a>
...
* Currently Python accepts numeric literals immediately followed by keywords,
  ...
  immediately followed by one of keywords [`and`](../reference/expressions.md#and), [`else`](../reference/compound_stmts.md#else),
  [`for`](../reference/compound_stmts.md#for), [`if`](../reference/compound_stmts.md#if), [`in`](../reference/expressions.md#in), [`is`](../reference/expressions.md#is) and [`or`](../reference/expressions.md#or).
...
* Starting in this release, there will be a concerted effort to begin
  ...
  (superseded by [`find_spec()`](../library/importlib.md#importlib.abc.MetaPathFinder.find_spec)),
  `importlib.abc.Loader.load_module`
  (superseded by [`exec_module()`](../library/importlib.md#importlib.abc.Loader.exec_module)),
  ...
  as other classes and methods in [`importlib`](../library/importlib.md#module-importlib)).
  [`ImportWarning`](../library/exceptions.md#ImportWarning) and/or [`DeprecationWarning`](../library/exceptions.md#DeprecationWarning) will be raised
...
* Non-integer arguments to [`random.randrange()`](../library/random.md#random.randrange) are deprecated.
  The [`ValueError`](../library/exceptions.md#ValueError) is deprecated in favor of a [`TypeError`](../library/exceptions.md#TypeError).
  (Contributed by Serhiy Storchaka and Raymond Hettinger in [bpo-37319](https://bugs.python.org/issue?@action=redirect&bpo=37319).)
* The various `load_module()` methods of [`importlib`](../library/importlib.md#module-importlib) have been
  documented as deprecated since Python 3.6, but will now also trigger
  a [`DeprecationWarning`](../library/exceptions.md#DeprecationWarning). Use
  [`exec_module()`](../library/importlib.md#importlib.abc.Loader.exec_module) instead.
...
* `zimport.zipimporter.load_module()` has been deprecated in
  preference for [`exec_module()`](../library/zipimport.md#zipimport.zipimporter.exec_module).
  (Contributed by Brett Cannon in [bpo-26131](https://bugs.python.org/issue?@action=redirect&bpo=26131).)
* The use of `importlib.abc.Loader.load_module` by the import
  system now triggers an [`ImportWarning`](../library/exceptions.md#ImportWarning) as
  [`exec_module()`](../library/importlib.md#importlib.abc.Loader.exec_module) is preferred.
  (Contributed by Brett Cannon in [bpo-26131](https://bugs.python.org/issue?@action=redirect&bpo=26131).)
* The use of `importlib.abc.MetaPathFinder.find_module()` and
  ...
  trigger an [`ImportWarning`](../library/exceptions.md#ImportWarning) as
  [`importlib.abc.MetaPathFinder.find_spec()`](../library/importlib.md#importlib.abc.MetaPathFinder.find_spec) and
  [`importlib.abc.PathEntryFinder.find_spec()`](../library/importlib.md#importlib.abc.PathEntryFinder.find_spec)
  are preferred, respectively. You can use
  [`importlib.util.spec_from_loader()`](../library/importlib.md#importlib.util.spec_from_loader) to help in porting.
...
* The use of `importlib.abc.PathEntryFinder.find_loader()` by the import
  system now triggers an [`ImportWarning`](../library/exceptions.md#ImportWarning) as
  [`importlib.abc.PathEntryFinder.find_spec()`](../library/importlib.md#importlib.abc.PathEntryFinder.find_spec) is preferred. You can use
  [`importlib.util.spec_from_loader()`](../library/importlib.md#importlib.util.spec_from_loader) to help in porting.
...
* The various implementations of
  ...
  now raise [`DeprecationWarning`](../library/exceptions.md#DeprecationWarning) and are slated for removal in
...
* `importlib.abc.Finder` is deprecated (including its sole method,
  `find_module()`). Both
  [`importlib.abc.MetaPathFinder`](../library/importlib.md#importlib.abc.MetaPathFinder) and [`importlib.abc.PathEntryFinder`](../library/importlib.md#importlib.abc.PathEntryFinder)
...
* The deprecations of `imp`, `importlib.find_loader()`,
  ...
  slated version of removal (they began raising [`DeprecationWarning`](../library/exceptions.md#DeprecationWarning) in
...
* `sqlite3.OptimizedUnicode` has been undocumented and obsolete since Python
  3.3, when it was made an alias to [`str`](../library/stdtypes.md#str).  It is now deprecated,
...
* The following `threading` methods are now deprecated:
  * `threading.currentThread` => [`threading.current_thread()`](../library/threading.md#threading.current_thread)
  * `threading.activeCount` => [`threading.active_count()`](../library/threading.md#threading.active_count)
  * `threading.Condition.notifyAll` =>
    [`threading.Condition.notify_all()`](../library/threading.md#threading.Condition.notify_all)
  * `threading.Event.isSet` => [`threading.Event.is_set()`](../library/threading.md#threading.Event.is_set)
  * `threading.Thread.setName` => [`threading.Thread.name`](../library/threading.md#threading.Thread.name)
  * `threading.thread.getName` => [`threading.Thread.name`](../library/threading.md#threading.Thread.name)
  * `threading.Thread.isDaemon` => [`threading.Thread.daemon`](../library/threading.md#threading.Thread.daemon)
  * `threading.Thread.setDaemon` => [`threading.Thread.daemon`](../library/threading.md#threading.Thread.daemon)
...
* `pathlib.Path.link_to()` is deprecated and slated for removal in
  Python 3.12. Use [`pathlib.Path.hardlink_to()`](../library/pathlib.md#pathlib.Path.hardlink_to) instead.
  (Contributed by Barney Gale in [bpo-39950](https://bugs.python.org/issue?@action=redirect&bpo=39950).)
...
* The following [`ssl`](../library/ssl.md#module-ssl) features have been deprecated since Python 3.6,
  ...
  * `OP_NO_SSLv2`, `OP_NO_SSLv3`, `OP_NO_TLSv1`,
    ...
    [`minimum_version`](../library/ssl.md#ssl.SSLContext.minimum_version) and
    [`maximum_version`](../library/ssl.md#ssl.SSLContext.maximum_version).
  * `PROTOCOL_SSLv2`, `PROTOCOL_SSLv3`,
    ...
    [`PROTOCOL_TLS_CLIENT`](../library/ssl.md#ssl.PROTOCOL_TLS_CLIENT) and [`PROTOCOL_TLS_SERVER`](../library/ssl.md#ssl.PROTOCOL_TLS_SERVER)
  * `wrap_socket()` is replaced by [`ssl.SSLContext.wrap_socket()`](../library/ssl.md#ssl.SSLContext.wrap_socket)
  * `match_hostname()`
  * `RAND_pseudo_bytes()`, `RAND_egd()`
  * NPN features like [`ssl.SSLSocket.selected_npn_protocol()`](../library/ssl.md#ssl.SSLSocket.selected_npn_protocol) and
    [`ssl.SSLContext.set_npn_protocols()`](../library/ssl.md#ssl.SSLContext.set_npn_protocols) are replaced by ALPN.
* The threading debug (`PYTHONTHREADDEBUG` environment variable) is
  deprecated in Python 3.10 and will be removed in Python 3.12. This feature
  requires a [debug build of Python](../using/configure.md#debug-build).
  (Contributed by Victor Stinner in [bpo-44584](https://bugs.python.org/issue?@action=redirect&bpo=44584).)
* Importing from the `typing.io` and `typing.re` submodules will now emit
  [`DeprecationWarning`](../library/exceptions.md#DeprecationWarning).  These submodules will be removed in a future version
  of Python.  Anything belonging to these submodules should be imported directly
  from [`typing`](../library/typing.md#module-typing) instead.
  (Contributed by Sebastian Rittau in [bpo-38291](https://bugs.python.org/issue?@action=redirect&bpo=38291).)

<a id="whatsnew310-removed"></a>

## Removed

* Removed special methods `__int__`, `__float__`, `__floordiv__`,
  `__mod__`, `__divmod__`, `__rfloordiv__`, `__rmod__` and
  `__rdivmod__` of the [`complex`](../library/functions.md#complex) class.  They always raised
...
* The `ParserBase.error()` method from the private and undocumented `_markupbase`
  module has been removed.  [`html.parser.HTMLParser`](../library/html.parser.md#html.parser.HTMLParser) is the only subclass of
...
* Remove deprecated aliases to [Collections Abstract Base Classes](../library/collections.abc.md#collections-abstract-base-classes) from
  the [`collections`](../library/collections.md#module-collections) module.
  (Contributed by Victor Stinner in [bpo-37324](https://bugs.python.org/issue?@action=redirect&bpo=37324).)
* The `loop` parameter has been removed from most of [`asyncio`](../library/asyncio.md#module-asyncio)‘s
  [high-level API](../library/asyncio-api-index.md) following deprecation
...
<a id="changes-python-api"></a>

### Changes in the Python API

* The *etype* parameters of the [`format_exception()`](../library/traceback.md#traceback.format_exception),
  [`format_exception_only()`](../library/traceback.md#traceback.format_exception_only), and
  [`print_exception()`](../library/traceback.md#traceback.print_exception) functions in the [`traceback`](../library/traceback.md#module-traceback) module
  have been renamed to *exc*.
  (Contributed by Zackery Spytz and Matthias Bussonnier in [bpo-26389](https://bugs.python.org/issue?@action=redirect&bpo=26389).)
* [`atexit`](../library/atexit.md#module-atexit): At Python exit, if a callback registered with
  [`atexit.register()`](../library/atexit.md#atexit.register) fails, its exception is now logged. Previously, only
...
* [`collections.abc.Callable`](../library/collections.abc.md#collections.abc.Callable) generic now flattens type parameters, similar
  ...
  accesses the arguments via [`typing.get_args()`](../library/typing.md#typing.get_args) or `__args__` need to account
  for this change.  Furthermore, [`TypeError`](../library/exceptions.md#TypeError) may be raised for invalid forms
  of parameterizing [`collections.abc.Callable`](../library/collections.abc.md#collections.abc.Callable) which may have passed
  silently in Python 3.9.
  (Contributed by Ken Jin in [bpo-42195](https://bugs.python.org/issue?@action=redirect&bpo=42195).)
* [`socket.htons()`](../library/socket.md#socket.htons) and [`socket.ntohs()`](../library/socket.md#socket.ntohs) now raise [`OverflowError`](../library/exceptions.md#OverflowError)
  instead of [`DeprecationWarning`](../library/exceptions.md#DeprecationWarning) if the given parameter will not fit in
...
* The `loop` parameter has been removed from most of [`asyncio`](../library/asyncio.md#module-asyncio)‘s
  ...
  using [`asyncio.run_coroutine_threadsafe()`](../library/asyncio-task.md#asyncio.run_coroutine_threadsafe) instead.

  (Contributed by Yurii Karabas, Andrew Svetlov, Yury Selivanov and Kyle Stanley
  in [bpo-42392](https://bugs.python.org/issue?@action=redirect&bpo=42392).)
* The [`types.FunctionType`](../library/types.md#types.FunctionType) constructor now inherits the current builtins
  if the *globals* dictionary has no `"__builtins__"` key, rather than using
  `{"None": None}` as builtins: same behavior as [`eval()`](../library/functions.md#eval) and
  [`exec()`](../library/functions.md#exec) functions.  Defining a function with `def function(...): ...`
...
* The C API functions `PyParser_SimpleParseStringFlags`,
  ...
  example, [`Py_CompileString()`](../c-api/veryhigh.md#c.Py_CompileString). The resulting code object can then be
  evaluated using, for example, [`PyEval_EvalCode()`](../c-api/veryhigh.md#c.PyEval_EvalCode).

  Specifically:
  * A call to `PyParser_SimpleParseStringFlags` followed by
    `PyNode_Compile` can be replaced by calling [`Py_CompileString()`](../c-api/veryhigh.md#c.Py_CompileString).
  * There is no direct replacement for `PyParser_SimpleParseFileFlags`.
    ...
    the file in C and pass the resulting buffer to [`Py_CompileString()`](../c-api/veryhigh.md#c.Py_CompileString).
  * To compile a file given a `char *` filename, explicitly open the file, read
    it and compile the result. One way to do this is using the [`io`](../library/io.md#module-io)
    module with [`PyImport_ImportModule()`](../c-api/import.md#c.PyImport_ImportModule), [`PyObject_CallMethod()`](../c-api/call.md#c.PyObject_CallMethod),
    [`PyBytes_AsString()`](../c-api/bytes.md#c.PyBytes_AsString) and [`Py_CompileString()`](../c-api/veryhigh.md#c.Py_CompileString),
    ...
    ```
  * For `FrameObject` objects, the [`f_lasti`](../reference/datamodel.md#frame.f_lasti) member now represents a wordcode
    ...
    instead (like [`PyCode_Addr2Line()`](../c-api/code.md#c.PyCode_Addr2Line) for example). Notice as well that the
    `f_lasti` member of `FrameObject` objects is not considered stable: please
    use [`PyFrame_GetLineNumber()`](../c-api/frame.md#c.PyFrame_GetLineNumber) instead.
...
* [`sqlite3`](../library/sqlite3.md#module-sqlite3) requires SQLite 3.7.15 or higher. (Contributed by Sergey Fedoseev
...
* The [`atexit`](../library/atexit.md#module-atexit) module must now always be built as a built-in module.
  (Contributed by Victor Stinner in [bpo-42639](https://bugs.python.org/issue?@action=redirect&bpo=42639).)
* Add [`--disable-test-modules`](../using/configure.md#cmdoption-disable-test-modules) option to the `configure` script:
...
* Add [`--with-wheel-pkg-dir=PATH option`](../using/configure.md#cmdoption-with-wheel-pkg-dir)
  to the `./configure` script. If
  specified, the [`ensurepip`](../library/ensurepip.md#module-ensurepip) module looks for `setuptools` and `pip`
...
* Add a new [`configure --without-static-libpython option`](../using/configure.md#cmdoption-without-static-libpython) to not build the `libpythonMAJOR.MINOR.a`
...
* Add [`--with-openssl-rpath`](../using/configure.md#cmdoption-with-openssl-rpath) option to `configure` script. The option
...
[C API and ABI Stability](../c-api/stable.md#stable) describes C API and ABI stability guarantees along with best
...
* The result of [`PyNumber_Index()`](../c-api/number.md#c.PyNumber_Index) now always has exact type [`int`](../library/functions.md#int).
  Previously, the result could have been an instance of a subclass of `int`.
  (Contributed by Serhiy Storchaka in [bpo-40792](https://bugs.python.org/issue?@action=redirect&bpo=40792).)
* Add a new [`orig_argv`](../c-api/init_config.md#c.PyConfig.orig_argv) member to the [`PyConfig`](../c-api/init_config.md#c.PyConfig)
  structure: the list of the original command line arguments passed to the
  Python executable.
  (Contributed by Victor Stinner in [bpo-23427](https://bugs.python.org/issue?@action=redirect&bpo=23427).)
* The [`PyDateTime_DATE_GET_TZINFO()`](../c-api/datetime.md#c.PyDateTime_DATE_GET_TZINFO) and
  [`PyDateTime_TIME_GET_TZINFO()`](../c-api/datetime.md#c.PyDateTime_TIME_GET_TZINFO) macros have been added for accessing
  the `tzinfo` attributes of [`datetime.datetime`](../library/datetime.md#datetime.datetime) and
  [`datetime.time`](../library/datetime.md#datetime.time) objects.
  (Contributed by Zackery Spytz in [bpo-30155](https://bugs.python.org/issue?@action=redirect&bpo=30155).)
* Add a [`PyCodec_Unregister()`](../c-api/codec.md#c.PyCodec_Unregister) function to unregister a codec
  search function.
  (Contributed by Hai Shi in [bpo-41842](https://bugs.python.org/issue?@action=redirect&bpo=41842).)
* The [`PyIter_Send()`](../c-api/iter.md#c.PyIter_Send) function was added to allow
...
* Add [`PyUnicode_AsUTF8AndSize()`](../c-api/unicode.md#c.PyUnicode_AsUTF8AndSize) to the limited C API.
  (Contributed by Alex Gaynor in [bpo-41784](https://bugs.python.org/issue?@action=redirect&bpo=41784).)
* Add [`PyModule_AddObjectRef()`](../c-api/module.md#c.PyModule_AddObjectRef) function: similar to
  [`PyModule_AddObject()`](../c-api/module.md#c.PyModule_AddObject) but don’t steal a reference to the value on
  success.
  (Contributed by Victor Stinner in [bpo-1635741](https://bugs.python.org/issue?@action=redirect&bpo=1635741).)
* Add [`Py_NewRef()`](../c-api/refcounting.md#c.Py_NewRef) and [`Py_XNewRef()`](../c-api/refcounting.md#c.Py_XNewRef) functions to increment the
...
* The [`PyType_FromSpecWithBases()`](../c-api/type.md#c.PyType_FromSpecWithBases) and [`PyType_FromModuleAndSpec()`](../c-api/type.md#c.PyType_FromModuleAndSpec)
...
* The [`PyType_FromModuleAndSpec()`](../c-api/type.md#c.PyType_FromModuleAndSpec) function now accepts NULL `tp_doc`
  slot.
  (Contributed by Hai Shi in [bpo-41832](https://bugs.python.org/issue?@action=redirect&bpo=41832).)
* The [`PyType_GetSlot()`](../c-api/type.md#c.PyType_GetSlot) function can accept
...
* Add a new [`PySet_CheckExact()`](../c-api/set.md#c.PySet_CheckExact) function to the C-API to check if an
  object is an instance of [`set`](../library/stdtypes.md#set) but not an instance of a subtype.
  (Contributed by Pablo Galindo in [bpo-43277](https://bugs.python.org/issue?@action=redirect&bpo=43277).)
* Add [`PyErr_SetInterruptEx()`](../c-api/exceptions.md#c.PyErr_SetInterruptEx) which allows passing a signal number
  to simulate.
  (Contributed by Antoine Pitrou in [bpo-43356](https://bugs.python.org/issue?@action=redirect&bpo=43356).)
* The limited C API is now supported if [Python is built in debug mode](../using/configure.md#debug-build) (if the `Py_DEBUG` macro is defined). In the limited C API,
  the [`Py_INCREF()`](../c-api/refcounting.md#c.Py_INCREF) and [`Py_DECREF()`](../c-api/refcounting.md#c.Py_DECREF) functions are now implemented
  as opaque function
  calls, rather than accessing directly the [`PyObject.ob_refcnt`](../c-api/structures.md#c.PyObject.ob_refcnt)
  ...
  in debug mode because the [`PyObject`](../c-api/structures.md#c.PyObject) structure is the same in release
  and debug mode since Python 3.8 (see [bpo-36465](https://bugs.python.org/issue?@action=redirect&bpo=36465)).

  The limited C API is still not supported in the [`--with-trace-refs`](../using/configure.md#cmdoption-with-trace-refs)
  special build (`Py_TRACE_REFS` macro).
  (Contributed by Victor Stinner in [bpo-43688](https://bugs.python.org/issue?@action=redirect&bpo=43688).)
* Add the [`Py_Is(x, y)`](../c-api/structures.md#c.Py_Is) function to test if the *x* object is
  the *y* object, the same as `x is y` in Python. Add also the
  [`Py_IsNone()`](../c-api/structures.md#c.Py_IsNone), [`Py_IsTrue()`](../c-api/structures.md#c.Py_IsTrue), [`Py_IsFalse()`](../c-api/structures.md#c.Py_IsFalse) functions to
...
* Add new functions to control the garbage collector from C code:
  [`PyGC_Enable()`](../c-api/gcsupport.md#c.PyGC_Enable),
  [`PyGC_Disable()`](../c-api/gcsupport.md#c.PyGC_Disable),
  [`PyGC_IsEnabled()`](../c-api/gcsupport.md#c.PyGC_IsEnabled).
  These functions allow to activate, deactivate and query the state of the garbage collector from C code without
  having to import the [`gc`](../library/gc.md#module-gc) module.
* Add a new [`Py_TPFLAGS_DISALLOW_INSTANTIATION`](../c-api/typeobj.md#c.Py_TPFLAGS_DISALLOW_INSTANTIATION) type flag to disallow
  creating type instances.
  (Contributed by Victor Stinner in [bpo-43916](https://bugs.python.org/issue?@action=redirect&bpo=43916).)
* Add a new [`Py_TPFLAGS_IMMUTABLETYPE`](../c-api/typeobj.md#c.Py_TPFLAGS_IMMUTABLETYPE) type flag for creating immutable
...
* The `PY_SSIZE_T_CLEAN` macro must now be defined to use
  [`PyArg_ParseTuple()`](../c-api/arg.md#c.PyArg_ParseTuple) and [`Py_BuildValue()`](../c-api/arg.md#c.Py_BuildValue) formats which use
  `#`: `es#`, `et#`, `s#`, `u#`, `y#`, `z#`, `U#` and `Z#`.
  See [Parsing arguments and building values](../c-api/arg.md#arg-parsing) and [**PEP 353**](https://peps.python.org/pep-0353/).
  (Contributed by Victor Stinner in [bpo-40943](https://bugs.python.org/issue?@action=redirect&bpo=40943).)
* Since [`Py_REFCNT()`](../c-api/refcounting.md#c.Py_REFCNT) is changed to the inline static function,
  `Py_REFCNT(obj) = new_refcnt` must be replaced with `Py_SET_REFCNT(obj, new_refcnt)`:
  see [`Py_SET_REFCNT()`](../c-api/refcounting.md#c.Py_SET_REFCNT) (available since Python 3.9). For backward
...
* Calling [`PyDict_GetItem()`](../c-api/dict.md#c.PyDict_GetItem) without [GIL](../glossary.md#term-GIL) held had been allowed
...
* `PyUnicode_FromUnicode(NULL, size)` and `PyUnicode_FromStringAndSize(NULL, size)`
  raise `DeprecationWarning` now.  Use [`PyUnicode_New()`](../c-api/unicode.md#c.PyUnicode_New) to allocate
...
* `Py_GetPath()`, `Py_GetPrefix()`, `Py_GetExecPrefix()`,
  ...
  [`Py_Initialize()`](../c-api/interp-lifecycle.md#c.Py_Initialize) (before Python is initialized). Use the new
  [Python Initialization Configuration](../c-api/init_config.md#init-config) API to get the [Python Path Configuration](../c-api/init_config.md#init-path-config).
  (Contributed by Victor Stinner in [bpo-42260](https://bugs.python.org/issue?@action=redirect&bpo=42260).)
* [`PyList_SET_ITEM()`](../c-api/list.md#c.PyList_SET_ITEM), [`PyTuple_SET_ITEM()`](../c-api/tuple.md#c.PyTuple_SET_ITEM) and
  [`PyCell_SET()`](../c-api/cell.md#c.PyCell_SET) macros can no longer be used as l-value or r-value.
...
* The non-limited API files `odictobject.h`, `parser_interface.h`,
  ...
  included in `Python.h`; see [Include Files](../c-api/intro.md#api-includes). If they have
  been included directly, consider including `Python.h` instead.
  (Contributed by Nicholas Sim in [bpo-35134](https://bugs.python.org/issue?@action=redirect&bpo=35134).)
* Use the [`Py_TPFLAGS_IMMUTABLETYPE`](../c-api/typeobj.md#c.Py_TPFLAGS_IMMUTABLETYPE) type flag to create immutable type
  objects. Do not rely on [`Py_TPFLAGS_HEAPTYPE`](../c-api/typeobj.md#c.Py_TPFLAGS_HEAPTYPE) to decide if a type
  object is mutable or not; check if [`Py_TPFLAGS_IMMUTABLETYPE`](../c-api/typeobj.md#c.Py_TPFLAGS_IMMUTABLETYPE) is set
  instead.
  (Contributed by Victor Stinner and Erlend E. Aasland in [bpo-43908](https://bugs.python.org/issue?@action=redirect&bpo=43908).)
...
* The `PyUnicode_InternImmortal()` function is now deprecated
  and will be removed in Python 3.12: use [`PyUnicode_InternInPlace()`](../c-api/unicode.md#c.PyUnicode_InternInPlace)
  instead.
...
* Removed `Py_UNICODE_str*` functions manipulating `Py_UNICODE*` strings.
  ...
  * `Py_UNICODE_strcpy`, `Py_UNICODE_strncpy`: use
    [`PyUnicode_CopyCharacters()`](../c-api/unicode.md#c.PyUnicode_CopyCharacters) or [`PyUnicode_Substring()`](../c-api/unicode.md#c.PyUnicode_Substring)
...
* Removed `PyLong_FromUnicode()`. Please migrate to [`PyLong_FromUnicodeObject()`](../c-api/long.md#c.PyLong_FromUnicodeObject).
  (Contributed by Inada Naoki in [bpo-41103](https://bugs.python.org/issue?@action=redirect&bpo=41103).)
* Removed `PyUnicode_AsUnicodeCopy()`. Please use [`PyUnicode_AsUCS4Copy()`](../c-api/unicode.md#c.PyUnicode_AsUCS4Copy) or
...
* Removed `_Py_CheckRecursionLimit` variable: it has been replaced by
  `ceval.recursion_limit` of the [`PyInterpreterState`](../c-api/subinterpreters.md#c.PyInterpreterState) structure.
...
* Removed undocumented macros `Py_ALLOW_RECURSION` and
  ...
  [`PyInterpreterState`](../c-api/subinterpreters.md#c.PyInterpreterState) structure.
...
* Removed the undocumented `PyOS_InitInterrupts()` function. Initializing
  ...
  [`PyConfig.install_signal_handlers`](../c-api/init_config.md#c.PyConfig.install_signal_handlers).
...
* Remove the `symtable.h` header file and the undocumented functions:
  ...
  * `Py_SymtableStringObject()`
  ...
  Use Python [`symtable`](../library/symtable.md#module-symtable) module instead.
  (Contributed by Victor Stinner in [bpo-43244](https://bugs.python.org/issue?@action=redirect&bpo=43244).)
* Remove [`PyOS_ReadlineFunctionPointer()`](../c-api/veryhigh.md#c.PyOS_ReadlineFunctionPointer) from the limited C API headers
...
* Remove `ast.h`, `asdl.h`, and `Python-ast.h` header files.
  ...
  Windows `<winbase.h>` header. Use the Python [`ast`](../library/ast.md#module-ast) module instead.
  (Contributed by Victor Stinner in [bpo-43244](https://bugs.python.org/issue?@action=redirect&bpo=43244).)
