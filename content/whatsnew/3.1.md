...
[`collections.OrderedDict`](../library/collections.md#collections.OrderedDict) class has been introduced.
...
modules.  The [`configparser`](../library/configparser.md#module-configparser) module uses them by default.  This lets
configuration files be read, modified, and then written back in their original
order.  The  *\_asdict()* method for [`collections.namedtuple()`](../library/collections.md#collections.namedtuple) now
returns an ordered dictionary with the values appearing in the same order as
the underlying tuple indices.  The [`json`](../library/json.md#module-json) module is being built-out with
...
The built-in [`format()`](../library/functions.md#format) function and the [`str.format()`](../library/stdtypes.md#str.format) method use
...
The supported types are [`int`](../library/functions.md#int), [`float`](../library/functions.md#float), [`complex`](../library/functions.md#complex)
and [`decimal.Decimal`](../library/decimal.md#decimal.Decimal).
...
* The [`int()`](../library/functions.md#int) type gained a `bit_length` method that returns the
...
* The fields in [`format()`](../library/functions.md#format) strings can now be automatically
  numbered:
  ```python3
...
* The `string.maketrans()` function is deprecated and is replaced by new
  static methods, [`bytes.maketrans()`](../library/stdtypes.md#bytes.maketrans) and [`bytearray.maketrans()`](../library/stdtypes.md#bytearray.maketrans).
  This change solves the confusion around which types were supported by the
  [`string`](../library/string.md#module-string) module. Now, [`str`](../library/stdtypes.md#str), [`bytes`](../library/stdtypes.md#bytes), and
  [`bytearray`](../library/stdtypes.md#bytearray) each have their own **maketrans** and **translate**
...
* The syntax of the [`with`](../reference/compound_stmts.md#with) statement now allows multiple context
...
* Added a [`collections.Counter`](../library/collections.md#collections.Counter) class to support convenient
...
* Added a new module, [`tkinter.ttk`](../library/tkinter.ttk.md#module-tkinter.ttk) for access to the Tk themed widget set.
...
* The [`gzip.GzipFile`](../library/gzip.md#gzip.GzipFile) and [`bz2.BZ2File`](../library/bz2.md#bz2.BZ2File) classes now support
...
* The [`decimal`](../library/decimal.md#module-decimal) module now supports methods for creating a
  decimal object from a binary [`float`](../library/functions.md#float).  The conversion is
...
* The [`itertools`](../library/itertools.md#module-itertools) module grew two new functions.  The
  [`itertools.combinations_with_replacement()`](../library/itertools.md#itertools.combinations_with_replacement) function is one of
  four for generating combinatorics including permutations and Cartesian
  products.  The [`itertools.compress()`](../library/itertools.md#itertools.compress) function mimics its namesake
  from APL.  Also, the existing [`itertools.count()`](../library/itertools.md#itertools.count) function now has
  an optional *step* argument and can accept any type of counting
  sequence including [`fractions.Fraction`](../library/fractions.md#fractions.Fraction) and
  [`decimal.Decimal`](../library/decimal.md#decimal.Decimal):
  ```python3
...
* [`collections.namedtuple()`](../library/collections.md#collections.namedtuple) now supports a keyword argument
...
* The [`re.sub()`](../library/re.md#re.sub), [`re.subn()`](../library/re.md#re.subn) and [`re.split()`](../library/re.md#re.split) functions now
  accept a flags parameter.

  (Contributed by Gregory Smith.)
* The [`logging`](../library/logging.md#module-logging) module now implements a simple [`logging.NullHandler`](../library/logging.handlers.md#logging.NullHandler)
...
* The [`runpy`](../library/runpy.md#module-runpy) module which supports the `-m` command line switch
...
* The [`pdb`](../library/pdb.md#module-pdb) module can now access and display source code loaded via
  [`zipimport`](../library/zipimport.md#module-zipimport) (or any other conformant [**PEP 302**](https://peps.python.org/pep-0302/) loader).

  (Contributed by Alexander Belopolsky; [bpo-4201](https://bugs.python.org/issue?@action=redirect&bpo=4201).)
* [`functools.partial`](../library/functools.md#functools.partial) objects can now be pickled.
...
* Add [`pydoc`](../library/pydoc.md#module-pydoc) help topics for symbols so that `help('@')`
  works as expected in the interactive environment.

  (Contributed by David Laban; [bpo-4739](https://bugs.python.org/issue?@action=redirect&bpo=4739).)
* The [`unittest`](../library/unittest.md#module-unittest) module now supports skipping individual tests or classes
  ...
  using the [`with`](../reference/compound_stmts.md#with) statement:
  ```python3
  ...
  [`assertSetEqual()`](../library/unittest.md#unittest.TestCase.assertSetEqual),
  [`assertDictEqual()`](../library/unittest.md#unittest.TestCase.assertDictEqual),
  `assertDictContainsSubset()`,
  [`assertListEqual()`](../library/unittest.md#unittest.TestCase.assertListEqual),
  [`assertTupleEqual()`](../library/unittest.md#unittest.TestCase.assertTupleEqual),
  [`assertSequenceEqual()`](../library/unittest.md#unittest.TestCase.assertSequenceEqual),
  [`assertRaisesRegexp()`](../library/unittest.md#unittest.TestCase.assertRaisesRegex),
  [`assertIsNone()`](../library/unittest.md#unittest.TestCase.assertIsNone),
  and [`assertIsNotNone()`](../library/unittest.md#unittest.TestCase.assertIsNotNone).

  (Contributed by Benjamin Peterson and Antoine Pitrou.)
* The [`io`](../library/io.md#module-io) module has three new constants for the [`seek()`](../library/io.md#io.IOBase.seek)
  method: [`SEEK_SET`](../library/os.md#os.SEEK_SET), [`SEEK_CUR`](../library/os.md#os.SEEK_CUR), and [`SEEK_END`](../library/os.md#os.SEEK_END).
* The [`sys.version_info`](../library/sys.md#sys.version_info) tuple is now a named tuple:
  ```python3
  >>> sys.version_info
...
* The `nntplib` and [`imaplib`](../library/imaplib.md#module-imaplib) modules now support IPv6.
...
* The [`pickle`](../library/pickle.md#module-pickle) module has been adapted for better interoperability with
...
* A new module, [`importlib`](../library/importlib.md#module-importlib) was added.  It provides a complete, portable,
  pure Python reference implementation of the [`import`](../reference/simple_stmts.md#import) statement and its
  counterpart, the [`__import__()`](../library/functions.md#import__) function.  It represents a substantial
...
* The [`json`](../library/json.md#module-json) module now has a C extension to substantially improve
  its performance.  In addition, the API was modified so that json works
  only with [`str`](../library/stdtypes.md#str), not with [`bytes`](../library/stdtypes.md#bytes).  That change makes the
...
* Integers are now stored internally either in base `2**15` or in base
  ...
  new [`sys.int_info`](../library/sys.md#sys.int_info) that provides information about the
...
* The [`PyLong_AsUnsignedLongLong()`](../c-api/long.md#c.PyLong_AsUnsignedLongLong) function now handles a negative
  *pylong* by raising [`OverflowError`](../library/exceptions.md#OverflowError) instead of [`TypeError`](../library/exceptions.md#TypeError).

  (Contributed by Mark Dickinson and Lisandro Dalcrin; [bpo-5175](https://bugs.python.org/issue?@action=redirect&bpo=5175).)
* Deprecated `PyNumber_Int()`.  Use [`PyNumber_Long()`](../c-api/number.md#c.PyNumber_Long) instead.

  (Contributed by Mark Dickinson; [bpo-4910](https://bugs.python.org/issue?@action=redirect&bpo=4910).)
* Added a new [`PyOS_string_to_double()`](../c-api/conversion.md#c.PyOS_string_to_double) function to replace the
...
* Added [`PyCapsule`](../c-api/capsule.md#c.PyCapsule) as a replacement for the `PyCObject` API.
