...
[`__index__()`](../reference/datamodel.md#object.__index__) method which is used to convert the object to an integer
number.
...
Raises [`ValueError`](exceptions.md#ValueError) if either of the arguments are negative.
