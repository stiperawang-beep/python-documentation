...
**Source code:** [Lib/pickletools.py](https://github.com/python/cpython/tree/main/Lib/pickletools.py)

---

This module contains various constants relating to the intimate details of the
[`pickle`](pickle.md#module-pickle) module, some lengthy comments about the implementation, and a
few useful functions for analyzing pickled data.  The contents of this module
are useful for Python core developers who are working on the [`pickle`](pickle.md#module-pickle);
ordinary users of the [`pickle`](pickle.md#module-pickle) module probably won’t find the
`pickletools` module relevant.

<a id="pickletools-cli"></a>
...
Provides an [iterator](../glossary.md#term-iterator) over all of the opcodes in a pickle, returning a
