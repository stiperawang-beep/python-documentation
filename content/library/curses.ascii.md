...
**Source code:** [Lib/curses/ascii.py](https://github.com/python/cpython/tree/main/Lib/curses/ascii.py)
...
| ### curses.ascii.ENQ | Enquiry, goes with [`ACK`](#curses.ascii.ACK) flow control |
| ### curses.ascii.ACK | Acknowledgement                                            |
| ### curses.ascii.BEL | Bell                                                       |
| ### curses.ascii.BS  | Backspace                                                  |
| ### curses.ascii.TAB | Tab                                                        |
| ### curses.ascii.HT  | Alias for [`TAB`](#curses.ascii.TAB): “Horizontal tab”     |
| ### curses.ascii.LF  | Line feed                                                  |
| ### curses.ascii.NL  | Alias for [`LF`](#curses.ascii.LF): “New line”             |
...
string, it is first converted using the built-in function [`ord()`](functions.md#ord).
