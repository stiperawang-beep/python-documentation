...
[`curses.doupdate()`](curses.md#curses.doupdate), so you’ll have to do this yourself.

<a id="curses-panel-objects"></a>

## Panel Objects

Panel objects, as returned by [`new_panel()`](#curses.panel.new_panel) above, are windows with a
