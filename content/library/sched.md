...
**Source code:** [Lib/sched.py](https://github.com/python/cpython/tree/main/Lib/sched.py)
...
The [`scheduler`](#sched.scheduler) class defines a generic interface to scheduling events.
...
#### Versionchanged
Changed in version 3.3: [`scheduler`](#sched.scheduler) class can be safely used in multi-threaded
environments.
...
<a id="scheduler-objects"></a>

## Scheduler Objects

[`scheduler`](#sched.scheduler) instances have the following methods and attributes:
...
(see [`cancel()`](#sched.scheduler.cancel)).
...
queue, this method will raise a [`ValueError`](exceptions.md#ValueError).
...
will be run.  Each event is shown as a [named tuple](../glossary.md#term-named-tuple) with the
