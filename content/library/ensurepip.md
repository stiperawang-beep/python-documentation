...
**Source code:** [Lib/ensurepip](https://github.com/python/cpython/tree/main/Lib/ensurepip)
...
#### SEE ALSO
[Installing Python modules](../installing/index.md#installing-index)
...
*verbosity* controls the level of output to [`sys.stdout`](sys.md#sys.stdout) from the
bootstrapping operation.

Raises an [auditing event](sys.md#auditing) `ensurepip.bootstrap` with argument `root`.
