...
**Source code:** [Lib/email/iterators.py](https://github.com/python/cpython/tree/main/Lib/email/iterators.py)

---

Iterating over a message object tree is fairly easy with the
[`Message.walk`](email.compat32-message.md#email.message.Message.walk) method.  The
...
a file using [`readline()`](io.md#io.TextIOBase.readline), skipping over all the
intervening headers.

Optional *decode* is passed through to [`Message.get_payload`](email.compat32-message.md#email.message.Message.get_payload).
...
Thus, by default [`typed_subpart_iterator()`](#email.iterators.typed_subpart_iterator) returns each subpart that has a
MIME type of *text/\**.
...
suitable for Python’s [`print()`](functions.md#print) function.  *level* is used internally.
