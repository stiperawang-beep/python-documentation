...
**Source code:** [Lib/getopt.py](https://github.com/python/cpython/tree/main/Lib/getopt.py)

#### NOTE
This module is considered feature complete. A more declarative and
extensible alternative to this API is provided in the [`optparse`](optparse.md#module-optparse)
...
or else as features in the [`argparse`](argparse.md#module-argparse) module.
...
using the [`argparse`](argparse.md#module-argparse) module instead. Users who are familiar with the Unix
...
using the [`optparse`](optparse.md#module-optparse) module. See [Choosing an argument parsing library](optparse.md#choosing-an-argument-parser) for
additional details.
...
two colons (`'::'`); i.e., the same format that Unix `getopt()` uses.
...
not match uniquely, so [`GetoptError`](#getopt.GetoptError) will be raised.
...
This function works like [`getopt()`](#module-getopt), except that GNU style scanning mode is
used by default. This means that option and non-option arguments may be
intermixed. The [`getopt()`](#module-getopt) function stops processing options as soon as a
...
Alias for [`GetoptError`](#getopt.GetoptError); for backward compatibility.
...
and more informative help and error messages by using the [`optparse`](optparse.md#module-optparse) module:
...
produced by using the [`argparse`](argparse.md#module-argparse) module:
...
See [Choosing an argument parsing library](optparse.md#choosing-an-argument-parser) for details on how the `argparse`
version of this code differs in behaviour from the `optparse` (and
`getopt`) version.

#### SEE ALSO
Module [`optparse`](optparse.md#module-optparse)
: Declarative command line option parsing.

Module [`argparse`](argparse.md#module-argparse)
