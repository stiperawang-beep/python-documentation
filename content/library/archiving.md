...
archives.  See also [Archiving operations](shutil.md#archiving-operations) provided by the [`shutil`](shutil.md#module-shutil)
module.
...
* [`compression.zstd` — Compression compatible with the Zstandard format](compression.zstd.md)
  * [Exceptions](compression.zstd.md#exceptions)
  * [Reading and writing compressed files](compression.zstd.md#reading-and-writing-compressed-files)
  * [Compressing and decompressing data in memory](compression.zstd.md#compressing-and-decompressing-data-in-memory)
  * [Zstandard dictionaries](compression.zstd.md#zstandard-dictionaries)
  * [Advanced parameter control](compression.zstd.md#advanced-parameter-control)
  * [Miscellaneous](compression.zstd.md#miscellaneous)
  * [Examples](compression.zstd.md#examples)
...
* [`tarfile` — Read and write tar archive files](tarfile.md)
  ...
  * [Examples](tarfile.md#examples)
    * [Reading examples](tarfile.md#reading-examples)
    * [Writing examples](tarfile.md#writing-examples)
