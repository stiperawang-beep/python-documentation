<a id="email-examples"></a>

# [`email`](email.md#module-email): Examples

Here are a few examples of how to use the [`email`](email.md#module-email) package to read, write,
...
Parsing [**RFC 822**](https://datatracker.ietf.org/doc/html/rfc822.html) headers can easily be done by the using the classes
from the [`parser`](email.parser.md#module-email.parser) module:
...
* <a id='id3'>**[1]**</a> Thanks to Matthew Dixon Cowles for the original inspiration and examples.
