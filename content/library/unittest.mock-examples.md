...
Common uses for [`Mock`](unittest.mock.md#unittest.mock.Mock) objects include:
...
#### NOTE
In most of these examples the [`Mock`](unittest.mock.md#unittest.mock.Mock) and [`MagicMock`](unittest.mock.md#unittest.mock.MagicMock) classes
are interchangeable. As the `MagicMock` is the more capable class it makes
a sensible one to use by default.

Once the mock has been called its [`called`](unittest.mock.md#unittest.mock.Mock.called) attribute is set to
`True`. More importantly we can use the [`assert_called_with()`](unittest.mock.md#unittest.mock.Mock.assert_called_with) or
[`assert_called_once_with()`](unittest.mock.md#unittest.mock.Mock.assert_called_once_with) method to check that it was called with
...
accessing it in the test will create it, but [`assert_called_with()`](unittest.mock.md#unittest.mock.Mock.assert_called_with)
...
and calls a method on it. The call to [`patch()`](unittest.mock.md#unittest.mock.patch) replaces the class `Foo` with a
mock. The `Foo` instance is the result of calling the mock, so it is configured
by modifying the mock [`return_value`](unittest.mock.md#unittest.mock.Mock.return_value).
...
[`mock_calls`](unittest.mock.md#unittest.mock.Mock.mock_calls) attribute records all calls
...
You use the [`call`](unittest.mock.md#unittest.mock.call) object to construct lists for comparing with
`mock_calls`:
...
We can use [`call`](unittest.mock.md#unittest.mock.call) to construct the set of calls in a “chained call” like
...
A useful attribute is [`side_effect`](unittest.mock.md#unittest.mock.Mock.side_effect). If you set this to an
...
[Asynchronous Iterators](../reference/datamodel.md#async-iterators) through `__aiter__`. The [`return_value`](unittest.mock.md#unittest.mock.Mock.return_value)
...
Since Python 3.8, `AsyncMock` and `MagicMock` have support to mock
[Asynchronous Context Managers](../reference/datamodel.md#async-context-managers) through `__aenter__` and `__aexit__`.
...
[`Mock`](unittest.mock.md#unittest.mock.Mock) allows you to provide an object as a specification for the mock,
...
you can use [auto-speccing](unittest.mock.md#auto-speccing).
...
[`mock_open()`](unittest.mock.md#unittest.mock.mock_open) is used to patch [`open()`](functions.md#open) method. [`side_effect`](unittest.mock.md#unittest.mock.Mock.side_effect)
...
#### NOTE
With [`patch()`](unittest.mock.md#unittest.mock.patch) it matters that you patch objects in the namespace where
they are looked up. This is normally straightforward, but for a quick guide
read [where to patch](unittest.mock.md#where-to-patch).
...
mock provides three convenient decorators for this: [`patch()`](unittest.mock.md#unittest.mock.patch), [`patch.object()`](unittest.mock.md#unittest.mock.patch.object) and
[`patch.dict()`](unittest.mock.md#unittest.mock.patch.dict). `patch` takes a single string, of the form
...
If you are patching a module (including [`builtins`](builtins.md#module-builtins)) then use [`patch()`](unittest.mock.md#unittest.mock.patch)
instead of [`patch.object()`](unittest.mock.md#unittest.mock.patch.object):
...
If you want to patch with a Mock, you can use [`patch()`](unittest.mock.md#unittest.mock.patch) with only one argument
(or [`patch.object()`](unittest.mock.md#unittest.mock.patch.object) with two arguments). The mock will be created for you and
...
There is also [`patch.dict()`](unittest.mock.md#unittest.mock.patch.dict) for setting values in a dictionary just
...
Where you use [`patch()`](unittest.mock.md#unittest.mock.patch) to create a mock for you, you can get a reference to the
...
understand the [`return_value`](unittest.mock.md#unittest.mock.Mock.return_value) attribute. When a mock is called for
the first time, or you fetch its `return_value` before it has been called, a
new [`Mock`](unittest.mock.md#unittest.mock.Mock) is created.
...
uses the builtin [`open()`](functions.md#open) as its `spec`.
...
We can do that in a slightly nicer way using the [`configure_mock()`](unittest.mock.md#unittest.mock.Mock.configure_mock)
...
Using [`mock_calls`](unittest.mock.md#unittest.mock.Mock.mock_calls) we can check the chained call with a single
assert. A chained call is several calls in one line of code, so there will be
several entries in `mock_calls`. We can use [`call.call_list()`](unittest.mock.md#unittest.mock.call.call_list) to create
...
For some tests, you may want to mock out a call to [`datetime.date.today()`](datetime.md#datetime.date.today)
to return a known date, but don’t want to prevent the code under test from
creating new date objects. Unfortunately [`datetime.date`](datetime.md#datetime.date) is written in C,
so you cannot just monkey-patch out the static [`datetime.date.today()`](datetime.md#datetime.date.today) method.
...
The [`patch decorator`](unittest.mock.md#unittest.mock.patch) is used here to
mock out the `date` class in the module under test. The [`side_effect`](unittest.mock.md#unittest.mock.Mock.side_effect)
...
Note that we don’t patch [`datetime.date`](datetime.md#datetime.date) globally, we patch `date` in the
module that *uses* it. See [where to patch](unittest.mock.md#where-to-patch).
...
A Python generator is a function or method that uses the [`yield`](../reference/simple_stmts.md#yield) statement
to return a series of values when iterated over <sup>[1](#id3)</sup>.

A generator method / function is called to return the generator object. It is
the generator object that is then iterated over. The protocol method for
iteration is [`__iter__()`](stdtypes.md#container.__iter__), so we can
mock this using a [`MagicMock`](unittest.mock.md#unittest.mock.MagicMock).
...
[`list`](stdtypes.md#list)), we need to configure the object returned by the call to `foo.iter()`.
...
An alternative way of managing patches is to use the [patch methods: start and stop](unittest.mock.md#start-and-stop).
...
[`unittest.TestCase.addCleanup()`](unittest.md#unittest.TestCase.addCleanup) makes this easier:
...
instead. The [`patch()`](unittest.mock.md#unittest.mock.patch) decorator makes it so simple to patch out methods
...
[`assert_called_once_with()`](unittest.mock.md#unittest.mock.Mock.assert_called_once_with) method that also asserts that the
[`call_count`](unittest.mock.md#unittest.mock.Mock.call_count) is one.
...
[`call_args_list`](unittest.mock.md#unittest.mock.Mock.call_args_list):
...
The [`call`](unittest.mock.md#unittest.mock.call) helper makes it easy to make assertions about these calls. You
...
Here’s one solution that uses the [`side_effect`](unittest.mock.md#unittest.mock.Mock.side_effect)
...
An alternative approach is to create a subclass of [`Mock`](unittest.mock.md#unittest.mock.Mock) or
[`MagicMock`](unittest.mock.md#unittest.mock.MagicMock) that copies (using [`copy.deepcopy()`](copy.md#copy.deepcopy)) the arguments.
...
With unittest `cleanup` functions and the [patch methods: start and stop](unittest.mock.md#start-and-stop) we can
...
We can do this with [`MagicMock`](unittest.mock.md#unittest.mock.MagicMock), which will behave like a dictionary,
and using [`side_effect`](unittest.mock.md#unittest.mock.Mock.side_effect) to delegate dictionary access to a real
underlying dictionary that is under our control.

When the [`__getitem__()`](../reference/datamodel.md#object.__getitem__) and [`__setitem__()`](../reference/datamodel.md#object.__setitem__) methods
...
[`call_args_list`](unittest.mock.md#unittest.mock.Mock.call_args_list) to assert about how the dictionary was used:
...
dictionary but recording the access. It even raises a [`KeyError`](exceptions.md#KeyError) if you try
...
There are various reasons why you might want to subclass [`Mock`](unittest.mock.md#unittest.mock.Mock). One
...
<sup>[2](#id5)</sup>. So if you’re subclassing to add helper methods then they’ll also be
...
* <a id='id5'>**[2]**</a> An exception to this rule are the non-callable mocks. Attributes use the callable variant because otherwise non-callable mocks couldn’t have callable methods.
...
Importing fetches an *object* from the [`sys.modules`](sys.md#sys.modules) dictionary. Note that it
fetches an *object*, which need not be a module. Importing a module for the
first time results in a module object being put in `sys.modules`, so usually
when you import something you get a module back. This need not be the case
however.

This means you can use [`patch.dict()`](unittest.mock.md#unittest.mock.patch.dict) to *temporarily* put a mock in place
in [`sys.modules`](sys.md#sys.modules). Any imports whilst this patch is active will fetch the mock.
...
left in [`sys.modules`](sys.md#sys.modules).
...
The [`Mock`](unittest.mock.md#unittest.mock.Mock) class allows you to track the *order* of method calls on
your mock objects through the [`method_calls`](unittest.mock.md#unittest.mock.Mock.method_calls) attribute. This
doesn’t allow you to track the order of calls between separate mock objects,
however we can use [`mock_calls`](unittest.mock.md#unittest.mock.Mock.mock_calls) to achieve the same effect.
...
them to a manager mock using the [`attach_mock()`](unittest.mock.md#unittest.mock.Mock.attach_mock) method. After
...
[`assert_has_calls()`](unittest.mock.md#unittest.mock.Mock.assert_has_calls) method. This takes a list of calls (constructed
with the [`call`](unittest.mock.md#unittest.mock.call) object). If that sequence of calls are in
[`mock_calls`](unittest.mock.md#unittest.mock.Mock.mock_calls) then the assert succeeds.
...
Using the same basic concept as [`ANY`](unittest.mock.md#unittest.mock.ANY) we can implement matchers to do more
...
defined classes). To use [`assert_called_with()`](unittest.mock.md#unittest.mock.Mock.assert_called_with) we would need to pass
...
`assert_called_with` passes, and if they don’t an [`AssertionError`](exceptions.md#AssertionError) is raised:
...
[`AssertionError`](exceptions.md#AssertionError) directly and provide a more useful failure message.
...
([hamcrest.library.integration.match_equality](https://pyhamcrest.readthedocs.io/en/release-1.8/integration/#module-hamcrest.library.integration.match_equality)).
