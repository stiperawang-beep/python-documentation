...
**Source code:** [Lib/xml/sax/saxutils.py](https://github.com/python/cpython/tree/main/Lib/xml/sax/saxutils.py)
...
Similar to [`escape()`](#xml.sax.saxutils.escape), but also prepares *data* to be used as an
attribute value.  The return value is a quoted version of *data* with any
additional required replacements. [`quoteattr()`](#xml.sax.saxutils.quoteattr) will select a quote
...
This class implements the [`ContentHandler`](xml.sax.handler.md#xml.sax.handler.ContentHandler) interface
by writing SAX
events back into an XML document. In other words, using an [`XMLGenerator`](#xml.sax.saxutils.XMLGenerator)
...
[`XMLReader`](xml.sax.reader.md#xml.sax.xmlreader.XMLReader) and the client
...
fully resolved [`InputSource`](xml.sax.reader.md#xml.sax.xmlreader.InputSource) object ready for
reading.  The input source can be given as a string, a file-like object, or
an [`InputSource`](xml.sax.reader.md#xml.sax.xmlreader.InputSource) object; parsers will use this
function to implement the polymorphic *source* argument to their
[`parse()`](xml.sax.reader.md#xml.sax.xmlreader.XMLReader.parse) method.
