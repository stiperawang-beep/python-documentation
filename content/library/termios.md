...
complete description of these calls, see  Unix manual
...
`sys.stdin.fileno()`, or a [file object](../glossary.md#term-file-object), such as `sys.stdin` itself.
...
a list like the one returned by [`tcgetattr()`](#termios.tcgetattr).  The *when* argument
...
[`tcgetwinsize()`](#termios.tcgetwinsize). Requires at least one of the pairs
...
#### SEE ALSO
Module [`tty`](tty.md#module-tty)
: Convenience functions for common terminal control operations.

<a id="termios-example"></a>

## Example

Here’s a function that prompts for a password with echoing turned off.  Note the
technique using a separate [`tcgetattr()`](#termios.tcgetattr) call and a [`try`](../reference/compound_stmts.md#try) …
[`finally`](../reference/compound_stmts.md#finally) statement to ensure that the old tty attributes are restored
