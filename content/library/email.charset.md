...
**Source code:** [Lib/email/charset.py](https://github.com/python/cpython/tree/main/Lib/email/charset.py)
...
This module provides a class [`Charset`](#email.charset.Charset) for representing character sets
and character set conversions in email messages, as well as a character set
registry and several convenience methods for manipulating this registry.
Instances of [`Charset`](#email.charset.Charset) are used in several other modules within the
[`email`](email.md#module-email) package.
...
[`Charset`](#email.charset.Charset) instances have the following data attributes:
...
[`Charset`](#email.charset.Charset) instances also have the following methods:
...
This is similar to [`header_encode()`](#email.charset.Charset.header_encode) except that the string is fit
...
The [`Charset`](#email.charset.Charset) class also provides a number of methods to support
...
This method allows you to compare two [`Charset`](#email.charset.Charset) instances for
equality.
...
module’s character set-to-codec mapping; use [`add_codec()`](#email.charset.add_codec) to add codecs the
module does not know about.  See the [`codecs`](codecs.md#module-codecs) module’s documentation for
more information.
...
Python codec, as appropriate for the second argument to the [`str`](stdtypes.md#str)’s
[`encode()`](stdtypes.md#str.encode) method.
