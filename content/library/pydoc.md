...
**Source code:** [Lib/pydoc.py](https://github.com/python/cpython/tree/main/Lib/pydoc.py)
...
derived from the docstring (i.e. the [`__doc__`](stdtypes.md#definition.__doc__) attribute) of the object,
and recursively of its documentable members.  If there is no docstring,
`pydoc` tries to obtain a description from the block of comment lines just
above the definition of the class, function or method in the source file, or at
the top of the module (see [`inspect.getcomments()`](inspect.md#inspect.getcomments)).

The built-in function [`help()`](functions.md#help) invokes the online help system in the
...
at a shell prompt will display documentation on the [`sys`](sys.md#module-sys) module, in a
...
#### Versionchanged
Changed in version 3.4: `pydoc` now uses [`inspect.signature()`](inspect.md#inspect.signature) rather than
[`inspect.getfullargspec()`](inspect.md#inspect.getfullargspec) to extract signature information from
callables.
