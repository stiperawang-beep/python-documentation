...
To translate a numeric error code to an error message, use [`os.strerror()`](os.md#os.strerror).
...
[`PermissionError`](exceptions.md#PermissionError).
...
[`ProcessLookupError`](exceptions.md#ProcessLookupError).
...
[`ChildProcessError`](exceptions.md#ChildProcessError).

### errno.EAGAIN

Try again. This error is mapped to the exception [`BlockingIOError`](exceptions.md#BlockingIOError).
...
[`FileExistsError`](exceptions.md#FileExistsError).
...
[`NotADirectoryError`](exceptions.md#NotADirectoryError).

### errno.EISDIR

Is a directory. This error is mapped to the exception
[`IsADirectoryError`](exceptions.md#IsADirectoryError).
...
[`BrokenPipeError`](exceptions.md#BrokenPipeError).
...
[`BlockingIOError`](exceptions.md#BlockingIOError).
...
exception [`ConnectionAbortedError`](exceptions.md#ConnectionAbortedError).

### errno.ECONNRESET

Connection reset by peer. This error is mapped to the exception
[`ConnectionResetError`](exceptions.md#ConnectionResetError).
...
to the exception [`BrokenPipeError`](exceptions.md#BrokenPipeError).
...
[`ConnectionRefusedError`](exceptions.md#ConnectionRefusedError).
...
exception [`BlockingIOError`](exceptions.md#BlockingIOError).
...
[Availability](intro.md#availability): WASI, FreeBSD
