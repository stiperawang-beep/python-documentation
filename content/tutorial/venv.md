...
The solution for this problem is to create a [virtual environment](../glossary.md#term-virtual-environment), a
...
[`venv`](../library/venv.md#module-venv).  [`venv`](../library/venv.md#module-venv) will install the Python version from which
the command was run (as reported by the [`--version`](../using/cmdline.md#cmdoption-version) option).
For instance, executing the command with `python3.12` will install
version 3.12.

To create a virtual environment, decide upon a directory where you want to
place it, and run the [`venv`](../library/venv.md#module-venv) module as a script with the directory path:
...
“freeze”, etc.  (Consult the [Installing Python modules](../installing/index.md#installing-index) guide for
...
`pip` has many more options.  Consult the [Installing Python modules](../installing/index.md#installing-index)
