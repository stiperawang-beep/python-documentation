...
<a id="tut-keybindings"></a>

## Tab Completion and History Editing

Completion of variable and module names is
[automatically enabled](../library/site.md#rlcompleter-config) at interpreter startup so
...
application-defined code if an object with a [`__getattr__()`](../reference/datamodel.md#object.__getattr__) method
is part of the expression.  The default configuration also saves your
history into a file named `.python_history` in your user directory.
The history will be available again during the next interactive interpreter
session.

<a id="tut-commentary"></a>
...
[`INDENT`](../library/token.md#token.INDENT) token is required next).  The completion mechanism might
