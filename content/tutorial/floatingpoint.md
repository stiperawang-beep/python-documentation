...
Historically, the Python prompt and built-in [`repr()`](../library/functions.md#repr) function would choose
...
[`round()`](../library/functions.md#round) function cannot help:
...
the [`math.isclose()`](../library/math.md#math.isclose) function can be useful for comparing inexact values:
...
Alternatively, the [`round()`](../library/functions.md#round) function can be used to compare rough
approximations:
...
[`str()`](../library/stdtypes.md#str) usually suffices, and for finer control see the [`str.format()`](../library/stdtypes.md#str.format)
method’s format specifiers in [Format string syntax](../library/string.md#formatstrings).

For use cases which require exact decimal representation, try using the
[`decimal`](../library/decimal.md#module-decimal) module which implements decimal arithmetic suitable for
accounting applications and high-precision applications.

Another form of exact arithmetic is supported by the [`fractions`](../library/fractions.md#module-fractions) module
which implements arithmetic based on rational numbers (so the numbers like
1/3 can be represented exactly).

If you are a heavy user of floating-point operations you should take a look
at the NumPy package and many other packages for mathematical and
statistical operations supplied by the SciPy project. See <[https://scipy.org](https://scipy.org)>.

Python provides tools that may help on those rare occasions when you really
*do* want to know the exact value of a float.  The
[`float.as_integer_ratio()`](../library/stdtypes.md#float.as_integer_ratio) method expresses the value of a float as a
fraction:
...
The [`float.hex()`](../library/stdtypes.md#float.hex) method expresses a float in hexadecimal (base
...
Another helpful tool is the [`sum()`](../library/functions.md#sum) function which helps mitigate
...
The [`math.fsum()`](../library/math.md#math.fsum) goes further and tracks all of the “lost digits”
as values are added onto a running total so that the result has only a
single rounding.  This is slower than [`sum()`](../library/functions.md#sum) but will be more
...
The [`fractions`](../library/fractions.md#module-fractions) and [`decimal`](../library/decimal.md#module-decimal) modules make these calculations
easy:
