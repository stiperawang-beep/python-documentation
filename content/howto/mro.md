...
development mailing list <sup>[1](#id4)</sup>.  In his post, Samuele showed that the
...
on Dylan and it is described in a paper intended for lispers <sup>[2](#id5)</sup>.  The
...
to invoke the [`mro()`](../reference/datamodel.md#type.mro) method of class A:
...
Guido points out in his essay <sup>[3](#id6)</sup> that the classic MRO is not so bad in
...
* <a id='id4'>**[1]**</a> The thread on python-dev started by Samuele Pedroni: [https://mail.python.org/pipermail/python-dev/2002-October/029035.html](https://mail.python.org/pipermail/python-dev/2002-October/029035.html)
* <a id='id5'>**[2]**</a> The paper *A Monotonic Superclass Linearization for Dylan*: [https://doi.org/10.1145/236337.236343](https://doi.org/10.1145/236337.236343)
* <a id='id6'>**[3]**</a> Guido van Rossum’s essay, *Unifying types and classes in Python 2.2*: [https://web.archive.org/web/20140210194412/http://www.python.org/download/releases/2.2.2/descrintro](https://web.archive.org/web/20140210194412/http://www.python.org/download/releases/2.2.2/descrintro)
