...
#### SEE ALSO
The [`multiprocessing`](../library/multiprocessing.md#module-multiprocessing) integrates cross-platform IPC into a higher-level
API.
...
that *there is no*  *on a socket.* I repeat: if a socket
