...
This tutorial is intended to be a gentle introduction to [`argparse`](../library/argparse.md#module-argparse), the
recommended command-line parsing module in the Python standard library.

#### NOTE
The standard library includes two other libraries directly related
to command-line parameter processing: the lower level [`optparse`](../library/optparse.md#module-optparse)
...
doesn’t support), and the very low level [`getopt`](../library/getopt.md#module-getopt) (which specifically
...
* The second one starts to display the usefulness of the [`argparse`](../library/argparse.md#module-argparse)
...
* We’ve added the [`add_argument()`](../library/argparse.md#argparse.ArgumentParser.add_argument) method, which is what we use to specify
  which command-line options the program is willing to accept. In this case,
  I’ve named it `echo` so that it’s in line with its function.
* Calling our program now requires us to specify an option.
* The [`parse_args()`](../library/argparse.md#argparse.ArgumentParser.parse_args) method actually returns some data from the
  options specified, in this case, `echo`.
* The variable is some form of ‘magic’ that [`argparse`](../library/argparse.md#module-argparse) performs for free
...
That didn’t go so well. That’s because [`argparse`](../library/argparse.md#module-argparse) treats the options we
give it as strings, unless we tell it otherwise. So, let’s tell
[`argparse`](../library/argparse.md#module-argparse) to treat that input as an integer:
...
* To show that the option is actually optional, there is no error when running
  ...
  test of the [`if`](../reference/compound_stmts.md#if) statement.
...
(hence the [`TypeError`](../library/exceptions.md#TypeError) exception).
...
The [`argparse`](../library/argparse.md#module-argparse) module is very powerful,
...
<a id="specifying-ambiguous-arguments"></a>

### Specifying ambiguous arguments

When there is ambiguity in deciding whether an argument is positional or for an
argument, `--` can be used to tell [`parse_args()`](../library/argparse.md#argparse.ArgumentParser.parse_args) that
...
[`argparse.ArgumentParser`](../library/argparse.md#argparse.ArgumentParser) instance. Let’s introduce a third one,
[`add_mutually_exclusive_group()`](../library/argparse.md#argparse.ArgumentParser.add_mutually_exclusive_group). It allows for us to specify options that
...
The output of the [`argparse`](../library/argparse.md#module-argparse) module such as its help text and error
messages are all made translatable using the [`gettext`](../library/gettext.md#module-gettext) module. This
allows applications to easily localize messages produced by
[`argparse`](../library/argparse.md#module-argparse). See also [Internationalizing your programs and modules](../library/gettext.md#i18n-howto).

For instance, in this [`argparse`](../library/argparse.md#module-argparse) output:
...
This command will extract all translatable strings from the [`argparse`](../library/argparse.md#module-argparse)
module and output them into a file named `messages.po`. This command assumes
that your Python installation is in `/usr/lib`.

You can find out the location of the [`argparse`](../library/argparse.md#module-argparse) module on your system
using this script:
...
installed using [`gettext`](../library/gettext.md#module-gettext), [`argparse`](../library/argparse.md#module-argparse) will be able to display the
translated messages.

To translate your own strings in the [`argparse`](../library/argparse.md#module-argparse) output, use [`gettext`](../library/gettext.md#module-gettext).

## Custom type converters

The [`argparse`](../library/argparse.md#module-argparse) module allows you to specify custom type converters for
your command-line arguments. This allows you to modify user input before it’s
stored in the [`argparse.Namespace`](../library/argparse.md#argparse.Namespace). This can be useful when you need to
...
The [`argparse`](../library/argparse.md#module-argparse) module offers a lot more than shown here.
