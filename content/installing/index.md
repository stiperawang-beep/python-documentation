...
* **pip** is the preferred installer program. It
...
* `virtualenv` is a third-party alternative (and predecessor) to
  `venv`.
* The [Python Package Index (PyPI)](https://pypi.org) is a public
...
this guide assume the use of a [virtual environment](../glossary.md#term-virtual-environment).
...
Creation of virtual environments is done through the [`venv`](../library/venv.md#module-venv) module.
...
aren’t currently easy to install using **pip** directly.
